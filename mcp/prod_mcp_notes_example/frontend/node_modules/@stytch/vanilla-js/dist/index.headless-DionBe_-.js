...
import { l as logger, d as __awaiter, ak as loadESModule, al as IframeHostClient, i as isTestPublicToken, am as EventLogger, an as DEFAULT_MAX_BATCH_SIZE, ao as DEFAULT_INTERVAL_DURATION_MS, ap as createEventId, aq as createAppSessionId, ar as createPersistentId, as as baseFetchSDK, at as baseSubmitFormSDK, au as _retriableFetchSDK, av as getPersistentStorageKey, aw as getKeyBoundStorage, ax as hasMultipleCookies, ay as isLocalhost, s as safeLocalStorage, az as safeSessionStorage, aA as HeadlessB2BOAuthClient$1, aB as DisabledDFPProtectedAuthProvider, e as OneTapPositions, ae as StytchSDKUsageError, aC as GOOGLE_ONE_TAP_HOST, aD as GOOGLE_ONE_TAP_SCRIPT_URL, j as StytchAPIError, aE as getTestApiURL, aF as getLiveApiURL, aG as getDFPBackendURL, aH as getDFPCdnURL, aI as CLIENTSIDE_SERVICES_IFRAME_URL, aJ as validate, _ as __rest, k as checkB2BNotSSR, aK as checkPublicToken, aL as StateChangeClient, aM as DFPProtectedAuthProvider, aN as HeadlessB2BOrganizationClient, aO as HeadlessB2BSelfClient, aP as HeadlessB2BSessionClient, aQ as HeadlessB2BMagicLinksClient, aR as HeadlessB2BSSOClient, aS as HeadlessB2BDiscoveryClient, aT as HeadlessB2BPasswordsClient, aU as HeadlessB2BOTPsClient, aV as HeadlessB2BTOTPsClient, aW as HeadlessB2BRecoveryCodesClient, aX as HeadlessB2BRBACClient, aY as HeadlessB2BSCIMClient, aZ as HeadlessB2BImpersonationClient, a_ as HeadlessB2BIDPClient, a$ as SessionManager, b0 as SearchDataManager, b1 as VERTICAL_CONSUMER, b2 as writeB2BInternals } from './internal-xYwHZs2R.js';
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              return _context3.a(2, baseFetchSDK({
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context4.a(2, baseSubmitFormSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context5.a(2, _retriableFetchSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer, _ref1) {
    ...
    this._listen = function (e) {
      if (e.key !== getPersistentStorageKey(_this5._publicToken, '')) {
        return;
      }
  ...
  function B2BSubscriptionService() {
    ...
    _this6.withUpdateSession = function (authenticate) {
      return function (options) {
        return __awaiter(_this6, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee8() {
          var resp;
...
var HeadlessB2BOAuthClient = /*#__PURE__*/function (_HeadlessB2BOAuthClie) {
  function HeadlessB2BOAuthClient(_networkClient, _subscriptionService, _pkceManager, _dynamicConfig, _config) {
    ...
    _this7.startOneTapDiscovery = function (options) {
      return __awaiter(_this7, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee9() {
    ...
    _this7.startOneTap = function (options) {
      return __awaiter(_this7, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee0() {
        var clientResult, client, onSuccessCallback;
  ...
  function B2BOneTapProvider(_networkClient, _pkceManager) {
    ...
    this.createOnDiscoverySuccessHandler = function (_ref11) {
      ...
      return function (response) {
        return __awaiter(_this9, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee10() {
    ...
    this.createOnSuccessHandler = function (_ref12) {
      ...
      return function (response) {
        return __awaiter(_this9, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee11() {
          var credential, submitPromise;
...
var createAuthUrlHandler = function createAuthUrlHandler(handlers) {
  ...
  var authenticateByUrl = function authenticateByUrl(_a, href) {
    return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee16() {
...
export { StytchB2BHeadlessClient as S, clearStytchTokenParams as c };
//# sourceMappingURL=index.headless-DionBe_-.js.map

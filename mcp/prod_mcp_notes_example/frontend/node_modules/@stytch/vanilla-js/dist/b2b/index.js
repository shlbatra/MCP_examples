...
var b2b_index_headless = require('../index.headless-Dj4KRdHg.js');
var extractErrorMessage = require('../extractErrorMessage-CObjEQHE.js');
...
var messages$1 = {
  ...
  "formField.countryCode.label": ["Country code"],
  ...
  "formField.phone.label": ["Phone number"],
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' ? extractErrorMessage.y : extractErrorMessage.p;
var useEvent = function useEvent(fn) {
  var handlerRef = extractErrorMessage._(fn);
  useIsomorphicLayoutEffect(function () {
    handlerRef.current = fn;
  }, [fn]);
  return extractErrorMessage.T(function () {
...
function getNextEnrollmentScreen(enabledMethods) {
...
var mfaReducer = function mfaReducer(state, action) {
  ...
  switch (action.type) {
    case 'primary_authenticate_success':
      {
        ...
        if (memberAuthenticated) {
          return replaceHistory(postAuthScreen, Object.assign(Object.assign({}, state), {
            mfa: DEFAULT_MFA_STATE,
            primary: {}
          }));
        }
        if (action.response.primary_required) {
          var primaryAuthMethods = action.response.primary_required.allowed_auth_methods;
          ...
          if ((primaryAuthMethods === null || primaryAuthMethods === void 0 ? void 0 : primaryAuthMethods.length) === 0) {
            return replaceHistory(AppScreens$1.Error, Object.assign(Object.assign({}, newBaseState), {
              error: {
          ...
          return replaceHistory(AppScreens$1.Main, newBaseState);
        }
        ...
        var primaryInfo = {
          ...
          organizationMfaOptionsSupported: action.response.organization.mfa_methods === 'RESTRICTED' ? (_b = (_a = action.response.organization.allowed_mfa_methods) === null || _a === void 0 ? void 0 : _a.map(apiMfaMethodToProduct).filter(extractErrorMessage.isTruthy)) !== null && _b !== void 0 ? _b : [] : [],
        ...
        var smsImplicitlySent = ((_c = action.response.mfa_required) === null || _c === void 0 ? void 0 : _c.secondary_auth_initiated) === 'sms_otp';
        var entryMethod = smsImplicitlySent ? internal.B2BMFAProducts.smsOtp : (_d = getDefaultMethod()) !== null && _d !== void 0 ? _d : primaryInfo.enrolledMfaMethods.find(organizationSupportsMethod);
        if (entryMethod) {
          ...
          switch (entryMethod) {
            case internal.B2BMFAProducts.totp:
              {
                return replaceHistory(AppScreens$1.TOTPEntry, Object.assign(Object.assign({}, state), {
                  mfa: mfaState,
                  primary: {}
                }));
              }
            case internal.B2BMFAProducts.smsOtp:
              {
                var nextState = Object.assign(Object.assign({}, state), {
                  mfa: Object.assign(Object.assign({}, mfaState), {
                    smsOtp: Object.assign(Object.assign({}, mfaState.smsOtp), {
                ...
                if (memberEnrolledInSmsOtp) {
                  return replaceHistory(AppScreens$1.SMSOTPEntry, nextState);
                } else {
                  return Object.assign(Object.assign({}, nextState), {
                    screen: AppScreens$1.SMSOTPEntry,
                    screenHistory: [AppScreens$1.SMSOTPEnrollment]
                  });
                }
              }
          }
        ...
        return replaceHistory(getNextEnrollmentScreen(enabledMethods), Object.assign(Object.assign({}, state), {
    ...
    case 'sms_otp/send_success':
      return pushHistory(AppScreens$1.SMSOTPEntry, Object.assign(Object.assign({}, state), {
        mfa: Object.assign(Object.assign({}, state.mfa), {
          smsOtp: Object.assign(Object.assign({}, state.mfa.smsOtp), {
            isSending: false,
            sendError: null,
            codeExpiration: getSmsOtpCodeExpiration(),
            formattedDestination: (_e = action.formattedPhoneNumber) !== null && _e !== void 0 ? _e : state.mfa.smsOtp.formattedDestination,
      ...
      return Object.assign(Object.assign({}, state), {
        mfa: Object.assign(Object.assign({}, state.mfa), {
          smsOtp: Object.assign(Object.assign({}, state.mfa.smsOtp), {
            ...
            codeExpiration: (_f = state.mfa.smsOtp.codeExpiration) !== null && _f !== void 0 ? _f : new Date(Date.now() - 1000)
          })
        })
      });
    ...
    case 'recovery_code/save_acknowledge':
      return replaceHistory((_h = (_g = state.mfa.primaryInfo) === null || _g === void 0 ? void 0 : _g.postAuthScreen) !== null && _h !== void 0 ? _h : AppScreens$1.LoggedIn, Object.assign(Object.assign({}, state), {
        mfa: DEFAULT_MFA_STATE
      }));
    case 'totp/authenticate_success':
      {
        var nextScreen = state.mfa.isEnrolling ? AppScreens$1.RecoveryCodeSave : (_k = (_j = state.mfa.primaryInfo) === null || _j === void 0 ? void 0 : _j.postAuthScreen) !== null && _k !== void 0 ? _k : AppScreens$1.LoggedIn;
        return replaceHistory(nextScreen, Object.assign(Object.assign({}, state), {
    ...
    case 'totp/create_success':
      if (!state.mfa.isEnrolling || ((_l = state.mfa.primaryInfo) === null || _l === void 0 ? void 0 : _l.memberId) !== action.memberId || ((_m = state.mfa.primaryInfo) === null || _m === void 0 ? void 0 : _m.organizationId) !== action.organizationId) {
        return state;
      }
      return Object.assign(Object.assign({}, state), {
        mfa: Object.assign(Object.assign({}, state.mfa), {
          totp: Object.assign(Object.assign({}, state.mfa.totp), {
            ...
            enrollment: {
              ...
              method: (_p = (_o = state.mfa.totp.enrollment) === null || _o === void 0 ? void 0 : _o.method) !== null && _p !== void 0 ? _p : 'qr'
            }
          })
        })
      });
    ...
    case 'totp/show_code':
      {
        ...
        var method = (_r = (_q = action.method) !== null && _q !== void 0 ? _q : state.mfa.totp.enrollment.method) !== null && _r !== void 0 ? _r : 'qr';
        var _nextScreen = method === 'manual' ? AppScreens$1.TOTPEnrollmentManual : AppScreens$1.TOTPEnrollmentQRCode;
        return pushHistory(_nextScreen, Object.assign(Object.assign({}, state), {
          mfa: Object.assign(Object.assign({}, state.mfa), {
            totp: Object.assign(Object.assign({}, state.mfa.totp), {
...
var reducer = function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'navigate_back':
      {
        ...
        var screenHistory = state.screenHistory.slice(0, -1);
        return Object.assign(Object.assign({}, state), {
          screen: screen,
    ...
    case 'send_email_otp':
      {
        return pushHistory(AppScreens$1.EmailOTPEntry, Object.assign(Object.assign({}, state), {
          formState: Object.assign(Object.assign({}, state.formState), {
            otpState: {
    ...
    case 'set_sso_discovery_state':
      {
        ...
        if (!connections.length) {
          return pushHistory(AppScreens$1.SSODiscoveryFallback, state);
        }
        return pushHistory(AppScreens$1.SSODiscoveryMenu, Object.assign(Object.assign({}, state), {
          formState: Object.assign(Object.assign({}, state.formState), {
            ssoDiscoveryState: {
    ...
    case 'use_password_auth':
      {
        return pushHistory(AppScreens$1.PasswordAuthenticate, Object.assign(Object.assign({}, state), {
          formState: Object.assign(Object.assign({}, state.formState), {
            passwordState: {
              email: action.email
            }
...
var useErrorCallback = function useErrorCallback() {
  var _a, _b;
  return useEvent((_b = (_a = useGlobalContext().callbacks) === null || _a === void 0 ? void 0 : _a.onError) !== null && _b !== void 0 ? _b : noop);
};
var useEventCallback = function useEventCallback() {
  var _a, _b;
  return useEvent((_b = (_a = useGlobalContext().callbacks) === null || _a === void 0 ? void 0 : _a.onEvent) !== null && _b !== void 0 ? _b : noop);
};
var AppScreens;
(function (AppScreens) {
  AppScreens["Main"] = "Main";
...
var createTheme = function createTheme(styles) {
  ...
  var fontFamily = styleConfig.fontFamily,
    colors = styleConfig.colors,
    container = styleConfig.container,
    buttons = styleConfig.buttons,
    inputs = styleConfig.inputs;
  return {
    typography: {
    ...
    container: {
      ...
      border: "1px solid ".concat(container.borderColor),
    ...
    buttons: {
      primary: {
        ...
        border: "1px solid ".concat(buttons.primary.borderColor),
      ...
      secondary: {
        ...
        border: "1px solid ".concat(buttons.secondary.borderColor),
      ...
      disabled: {
        ...
        border: "1px solid ".concat(buttons.disabled.borderColor),
        borderRadius: buttons.disabled.borderRadius
      }
    },
    inputs: {
      backgroundColor: (_a = inputs === null || inputs === void 0 ? void 0 : inputs.backgroundColor) !== null && _a !== void 0 ? _a : 'transparent',
      textColor: (_b = inputs === null || inputs === void 0 ? void 0 : inputs.textColor) !== null && _b !== void 0 ? _b : colors.primary,
      borderColor: (_c = inputs === null || inputs === void 0 ? void 0 : inputs.borderColor) !== null && _c !== void 0 ? _c : colors.primary,
      borderRadius: (_d = inputs === null || inputs === void 0 ? void 0 : inputs.borderRadius) !== null && _d !== void 0 ? _d : '4px',
      placeholderColor: (_e = inputs === null || inputs === void 0 ? void 0 : inputs.placeholderColor) !== null && _e !== void 0 ? _e : defaultDisabledTextColor
    },
...
function useErrorProps(error) {
  var errorId = extractErrorMessage.useUniqueId();
  if (!error) {
    return {
      error: {
        id: errorId
...
var focusedRing = extractErrorMessage.Ce(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  outline: 2px auto -webkit-focus-ring-color;\n  outline: 2px auto Highlight;\n  outline-offset: 2px;\n"])));
var BaseButton = extractErrorMessage.He.button(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  all: unset;\n\n  cursor: pointer;\n  font-family: ", ";\n\n  &:focus-visible {\n    ", "\n  }\n\n  &:disabled {\n    cursor: not-allowed;\n  }\n"])), function (props) {
  return props.theme.typography.fontFamily;
}, focusedRing);
var BackButton = extractErrorMessage.He(BaseButton)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  &:focus-visible {\n    // Move the focus ring to the inner SVG\n    outline: none;\n\n    svg {\n      ", "\n    }\n  }\n"])), focusedRing);
...
var ErrorHeader = extractErrorMessage.He(Text)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
...
var Input = extractErrorMessage.He.input(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  height: 47px;\n  padding: 0 8px;\n  box-sizing: border-box;\n  border: 1px solid ", ";\n  border-radius: ", ";\n  color: ", ";\n  font-family: ", ";\n  font-size: 18px;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    border: 1px solid ", ";\n    color: ", ";\n    background-color: ", ";\n  }\n"])), function (props) {
...
var EmailInput = function EmailInput(_a) {
  var email = _a.email,
    setEmail = _a.setEmail,
    _a$disableInput = _a.disableInput,
    disableInput = _a$disableInput === void 0 ? false : _a$disableInput,
    _a$hasPasskeys = _a.hasPasskeys,
    hasPasskeys = _a$hasPasskeys === void 0 ? false : _a$hasPasskeys,
    additionalProps = internal.__rest(_a, ["email", "setEmail", "disableInput", "hasPasskeys"]);
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Input, Object.assign({
    ...
    required: true
  }, hasPasskeys ? extractErrorMessage.passwordManagerDisableAutofillProps : {}, additionalProps));
};
...
var ErrorText = function ErrorText(_ref32) {
  var errorMessage = _ref32.errorMessage,
    id = _ref32.id;
...
var Button = extractErrorMessage.He(BaseButton)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 45px;\n  font-size: 18px;\n  text-transform: none;\n  box-shadow: none;\n  text-align: center;\n\n  ", "\n\n  &:disabled {\n    background-color: ", ";\n    color: ", ";\n    border: ", ";\n    border-radius: ", ";\n  }\n"])), function (props) {
...
var circularRotateKeyframe = extractErrorMessage.Ue(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
var circularDashKeyframe = extractErrorMessage.Ue(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  0% {\n    stroke-dasharray: 1px, 200px;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -15px;\n  }\n  100% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -125px;\n  }\n"])));
var AnimatedCircle = extractErrorMessage.He.circle(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  stroke-dasharray: 80px, 200px;\n  stroke-dashoffset: 0;\n  animation: ", " 1.4s ease-in-out infinite;\n  stroke: ", ";\n  fill: none;\n"])), circularDashKeyframe, function (props) {
...
var CircularProgress = function CircularProgress(_ref33) {
  var size = _ref33.size,
    thickness = _ref33.thickness;
...
var SubmitButton = function SubmitButton(_ref34) {
  var isSubmitting = _ref34.isSubmitting,
    disabled = _ref34.disabled,
    text = _ref34.text,
    variant = _ref34.variant;
...
var authMethodsToProducts = Object.fromEntries(Object.entries(productsToAuthMethods).map(function (_ref35) {
  var _ref36 = _slicedToArray(_ref35, 2),
    product = _ref36[0],
    authMethod = _ref36[1];
  return [authMethod, product];
}));
var oauthMethodsToOauthProviders = Object.fromEntries(Object.entries(oauthProvidersToAuthMethods).map(function (_ref37) {
...
var flattenConfigToAuthMethods = function flattenConfigToAuthMethods(products, oauthProviders) {
  return products.flatMap(function (product) {
    if (product === internal.B2BProducts.oauth) {
      return oauthProviders.map(function (provider) {
      ...
      var authMethod = productsToAuthMethods[product];
      if (authMethod) {
        return authMethod;
      }
    }
...
var useEffectiveAuthConfig = function useEffectiveAuthConfig() {
  ...
  var oauthProviderSettings = extractErrorMessage.F(function () {
    return authMethodsToShow.map(function (authMethod) {
      var _a;
      var provider = oauthMethodsToOauthProviders[authMethod];
      if (provider) {
...
var mutation = function mutation() {
  return function (key, fetcher) {
    ...
    var trigger = extractErrorMessage.T(/*#__PURE__*/function () {
      var _ref39 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(arg, opts) {
        var _extractErrorMessage$8, _extractErrorMessage$9, serializedKey, resolvedKey, options, mutationStartedAt, data, _t4;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 5:
              ...
              options.onError == null ? void 0 : options.onError(_t4, serializedKey, options);
...
function getStytchEventByKey(key) {
  return KeyToStytchEventMap[key];
}
var useMutate = function useMutate(key, fetcher) {
  ...
  return index(key, fetcher, Object.assign(Object.assign({
    ...
    onSuccess: function onSuccess(data, key, config) {
      var _a;
      var eventType = getStytchEventByKey(key);
      if (eventType) {
        onEvent({
          type: eventType,
          data: data
      ...
      (_a = options.onSuccess) === null || _a === void 0 ? void 0 : _a.call(options, data, key, config);
    },
    onError: function onError(error, key, config) {
      var _a;
      _onError(error);
      (_a = options.onError) === null || _a === void 0 ? void 0 : _a.call(options, error, key, config);
    }
  }));
};
var useExtractSlug = function useExtractSlug() {
  ...
  var _useMutate = useMutate('stytch.organization.getBySlug', function (_, _ref40) {
...
var useBootstrap = function useBootstrap() {
  ...
  var _extractErrorMessage$10 = extractErrorMessage.h(internal.readB2BInternals(stytchClient).bootstrap.getSync()),
    ...
    bootstrap = _extractErrorMessage$11[0],
...
var useEmailOtpDiscoverySend = function useEmailOtpDiscoverySend() {
  var _ref43 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    throwOnError = _ref43.throwOnError;
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.otps.email.discovery.send', function (_key, _ref44) {
    var email = _ref44.arg.email;
    var _a, _b;
...
var useEmailOtpLoginOrSignup = function useEmailOtpLoginOrSignup() {
  var _ref45 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    throwOnError = _ref45.throwOnError;
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.otps.email.loginOrSignup', function (_key, _ref46) {
    var _ref46$arg = _ref46.arg,
      email = _ref46$arg.email,
      organization_id = _ref46$arg.organization_id;
    var _a, _b, _c;
...
var useEmlDiscoverySend = function useEmlDiscoverySend() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.magicLinks.email.discovery.send', function (_, _ref47) {
    var email = _ref47.arg.email;
    var _a, _b, _c;
...
var useEmlLoginOrSignup = function useEmlLoginOrSignup() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.magicLinks.email.loginOrSignup', function (_, _ref48) {
    var _ref48$arg = _ref48.arg,
      email = _ref48$arg.email,
      organization_id = _ref48$arg.organization_id;
    var _a, _b, _c, _d, _e;
...
var HelpButton = extractErrorMessage.He(Button).attrs({
  variant: 'text',
  type: 'button'
  ...
  var theme = _ref49.theme,
    _ref49$themeColor = _ref49.themeColor,
    themeColor = _ref49$themeColor === void 0 ? 'secondary' : _ref49$themeColor;
...
var PasswordUseButton = function PasswordUseButton(_ref50) {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(HelpButton, {
    themeColor: "primary",
...
var useParseErrorMessage = function useParseErrorMessage() {
  var _extractErrorMessage$13 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$13._;
...
var EmailForm = function EmailForm(_ref52) {
  ...
  var _extractErrorMessage$14 = extractErrorMessage.h(state.formState.passwordState.email),
    _extractErrorMessage$15 = _slicedToArray(_extractErrorMessage$14, 2),
    emailInput = _extractErrorMessage$15[0],
    setEmailInput = _extractErrorMessage$15[1];
  var parseErrorMessage = useParseErrorMessage();
  var _extractErrorMessage$16 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$16._;
  ...
  var emailProps = useErrorProps(error);
  var emailInputLabel = _t2({
  ...
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee2() {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement("form", {
    ...
    direction: "column",
    minHeight: 52
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(EmailInput, Object.assign({
    email: email,
    setEmail: setEmailInput,
    "aria-label": emailInputLabel
  }, emailProps.input)), error && (/*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, Object.assign({
    errorMessage: parseErrorMessage(error, {
      email: email,
      org: organization.organization_name
    })
  }, emailProps.error)))), /*#__PURE__*/extractErrorMessage.wn.createElement(SubmitButton, {
...
var EmailDiscoveryForm = function EmailDiscoveryForm(_ref53) {
  ...
  var _extractErrorMessage$17 = extractErrorMessage.h(state.formState.passwordState.email),
    _extractErrorMessage$18 = _slicedToArray(_extractErrorMessage$17, 2),
    email = _extractErrorMessage$18[0],
    setEmail = _extractErrorMessage$18[1];
  var _extractErrorMessage$19 = extractErrorMessage.useLingui(),
    _t3 = _extractErrorMessage$19._;
  ...
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee3() {
...
var Divider = function Divider() {
  var _extractErrorMessage$20 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$20._;
...
var LoggingInScreen = function LoggingInScreen() {
  ...
  return /*#__PURE__*/extractErrorMessage.y$1(Flex, {
    direction: "column",
    gap: 36,
    alignItems: "center"
  }, /*#__PURE__*/extractErrorMessage.y$1(Text, {
    size: "header"
  }, _t({
    id: 'login.loading',
    message: "Logging in..."
  })), /*#__PURE__*/extractErrorMessage.y$1(CircularProgress, {
    size: 100,
    thickness: 8
  }));
};
...
var PasswordIconButton = extractErrorMessage.He(BaseButton)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  height: 20px;\n  color: ", ";\n\n  &:disabled {\n    cursor: default;\n  }\n"])), function (props) {
  return props.passwordEntered ? props.theme.inputs.textColor : props.theme.colors.disabledText;
});
var PasswordIcon = function PasswordIcon(_ref54) {
  var onClick = _ref54.onClick,
    passwordEntered = _ref54.passwordEntered,
    visible = _ref54.visible;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordIconButton, {
    ...
    "aria-label": visible ? _t({
      id: 'button.hidePassword',
      message: "Hide password"
    }) : _t({
      id: 'button.showPassword',
...
var PasswordInput = function PasswordInput(_a) {
  var password = _a.password,
    setPassword = _a.setPassword,
    type = _a.type,
    additionalProps = internal.__rest(_a, ["password", "setPassword", "type"]);
  var _extractErrorMessage$23 = extractErrorMessage.h(false),
    _extractErrorMessage$24 = _slicedToArray(_extractErrorMessage$23, 2),
    visible = _extractErrorMessage$24[0],
    setVisible = _extractErrorMessage$24[1];
  return /*#__PURE__*/extractErrorMessage.wn.createElement(InputContainer, {
    gap: 2,
    alignItems: "center"
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(BaseInput, Object.assign({
    name: "password",
    ...
    required: true
  }, additionalProps)), /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordIcon, {
    onClick: function onClick() {
...
var usePasswordInput = function usePasswordInput() {
  ...
  var _extractErrorMessage$28 = extractErrorMessage.h(''),
    _extractErrorMessage$29 = _slicedToArray(_extractErrorMessage$28, 2),
    password = _extractErrorMessage$29[0],
    setPassword = _extractErrorMessage$29[1];
  var _extractErrorMessage$30 = extractErrorMessage.h(''),
    _extractErrorMessage$31 = _slicedToArray(_extractErrorMessage$30, 2),
    errorMessage = _extractErrorMessage$31[0],
    setErrorMessage = _extractErrorMessage$31[1];
  var _extractErrorMessage$32 = extractErrorMessage.h(false),
    _extractErrorMessage$33 = _slicedToArray(_extractErrorMessage$32, 2),
    isSubmitting = _extractErrorMessage$33[0],
    setIsSubmitting = _extractErrorMessage$33[1];
  var organization = state.flowState.organization;
  ...
  var emailEligibleForJITProvisioning = function emailEligibleForJITProvisioning(_ref55, email) {
    var email_jit_provisioning = _ref55.email_jit_provisioning,
      email_allowed_domains = _ref55.email_allowed_domains;
...
var Label = extractErrorMessage.He.label(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  all: unset;\n  display: block;\n  cursor: default;\n  width: fit-content;\n\n  color: ", ";\n  ", ";\n"])), function (props) {
  return props.theme.colors.secondary;
}, function (props) {
...
var PasswordsEmailForm = function PasswordsEmailForm() {
  ...
  var _extractErrorMessage$34 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$34._;
  var _usePasswordInput = usePasswordInput(),
    stytch = _usePasswordInput.stytch,
    ...
    setIsSubmitting = _usePasswordInput.setIsSubmitting,
    submitPassword = _usePasswordInput.submitPassword,
    submitDiscoveryPassword = _usePasswordInput.submitDiscoveryPassword,
    handleNonMemberReset = _usePasswordInput.handleNonMemberReset;
  var _extractErrorMessage$35 = extractErrorMessage.h(!!organization && !email),
    _extractErrorMessage$36 = _slicedToArray(_extractErrorMessage$35, 2),
    hideInput = _extractErrorMessage$36[0],
    setHideInput = _extractErrorMessage$36[1];
  var emailProps = useErrorProps(errorMessage);
  var passwordProps = useErrorProps(errorMessage);
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee4() {
      var organization_id;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          ...
          case 2:
            setErrorMessage('');
            setIsSubmitting(true);
            internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref56) {
              var member = _ref56.member;
              if (member) {
                setHideInput(false);
                setIsSubmitting(false);
                dispatch({
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    direction: "column",
    gap: 2
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Label, {
    htmlFor: "email-input"
  }, _t({
    id: 'formField.email.label',
    message: "Email"
    ...
    email: email,
    setEmail: setEmail
  }, emailProps.input))), !hideInput && (/*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    direction: "column",
    gap: 2
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Label, {
    ...
    message: "Password"
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordInput, Object.assign({
    password: password,
    setPassword: setPassword,
    type: "current"
  }, passwordProps.input)))), /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, Object.assign({
    errorMessage: errorMessage
  }, passwordProps.error)), /*#__PURE__*/extractErrorMessage.wn.createElement(SubmitButton, {
    isSubmitting: isSubmitting,
    text: _t({
      id: 'button.continue',
      message: "Continue"
    })
  }), !hideInput && (/*#__PURE__*/extractErrorMessage.wn.createElement(HelpButton, {
    onClick: onGetHelp
  }, _t({
...
var ButtonInnerContainer = extractErrorMessage.He(Flex)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin: 8px;\n"])));
var StyledButton$2 = extractErrorMessage.He(Button)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  height: auto;\n  min-height: 45px;\n"])));
var AuthButton = function AuthButton(_a) {
  var children = _a.children,
    icon = _a.icon,
    buttonProps = internal.__rest(_a, ["children", "icon"]);
  return /*#__PURE__*/extractErrorMessage.wn.createElement(StyledButton$2, Object.assign({
    type: "button",
    variant: "outlined"
  }, buttonProps), /*#__PURE__*/extractErrorMessage.wn.createElement(ButtonInnerContainer, {
    justifyContent: "center",
    alignItems: "center",
    gap: 4
  }, icon, /*#__PURE__*/extractErrorMessage.wn.createElement("span", {
    style: {
...
var providerInfo = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, internal.B2BOAuthProviders.Google, {
  ...
  icon: /*#__PURE__*/extractErrorMessage.wn.createElement(MicrosoftIcon, null)
}), internal.B2BOAuthProviders.HubSpot, {
  messageDescriptor: {
    id: 'oauth.continueWithHubSpot',
    message: "Continue with HubSpot"
  },
  icon: /*#__PURE__*/extractErrorMessage.wn.createElement(HubSpotIcon, null)
}), internal.B2BOAuthProviders.Slack, {
  messageDescriptor: {
    id: 'oauth.continueWithSlack',
    message: "Continue with Slack"
  },
  icon: /*#__PURE__*/extractErrorMessage.wn.createElement(SlackIcon, null)
}), internal.B2BOAuthProviders.GitHub, {
  messageDescriptor: {
    id: 'oauth.continueWithGitHub',
    message: "Continue with GitHub"
  },
  icon: /*#__PURE__*/extractErrorMessage.wn.createElement(GitHubIcon, null)
});
var defaultProviderInfo = {
  messageDescriptor: null,
  icon: /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null)
};
var OAuthB2BButton = function OAuthB2BButton(_ref57) {
  var providerType = _ref57.providerType,
    loginRedirectUrl = _ref57.loginRedirectUrl,
    signupRedirectUrl = _ref57.signupRedirectUrl,
    discoveryRedirectUrl = _ref57.discoveryRedirectUrl,
    customScopes = _ref57.customScopes,
    providerParams = _ref57.providerParams,
    onSuccess = _ref57.onSuccess;
  var _a;
  ...
  var _ref58 = (_a = providerInfo[providerType]) !== null && _a !== void 0 ? _a : defaultProviderInfo,
    messageDescriptor = _ref58.messageDescriptor,
    icon = _ref58.icon;
  var onButtonClick = function onButtonClick() {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee5() {
      var providerClient;
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          case 0:
            providerClient = stytchClient.oauth[providerType];
            if (!state.flowState.organization) {
              _context5.n = 2;
              break;
            }
            _context5.n = 1;
            return providerClient.start({
          ...
          case 2:
            _context5.n = 3;
            return providerClient.discovery.start({
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(AuthButton, {
    id: "oauth-".concat(providerType),
    onClick: onButtonClick,
    icon: icon
  }, messageDescriptor ? _t(messageDescriptor) : null);
};
var OAuthErrorMessage = function OAuthErrorMessage(_ref59) {
...
var RedirectUrlsErrorMessage = function RedirectUrlsErrorMessage(_ref60) {
  var niceName = _ref60.niceName,
    variableName = _ref60.variableName;
...
function useLastUsedAuthMethod() {
  var stytch = useStytch();
  var _internal$readB2BInte = internal.readB2BInternals(stytch),
    publicToken = _internal$readB2BInte.publicToken;
  var lastUsedMethod = extractErrorMessage.F(function () {
    return internal.safeLocalStorage.getItem(publicToken, 'b2b_last_used_method');
  }, [publicToken]);
  var setLastUsedMethod = function setLastUsedMethod(method) {
    internal.safeLocalStorage.setItem(publicToken, 'b2b_last_used_method', method);
  };
  return [lastUsedMethod, setLastUsedMethod];
}
var B2BGoogleOneTap = function B2BGoogleOneTap(_ref61) {
  var customScopes = _ref61.customScopes,
    providerParams = _ref61.providerParams,
    cancelOnTapOutside = _ref61.cancelOnTapOutside;
  var _a, _b, _c, _d, _e, _f;
  var _extractErrorMessage$38 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$38._;
  var stytch = useStytch();
  var config = useConfig();
  var isOnlyFloatingOneTap = useIsOnlyFloatingOneTap();
  var _extractErrorMessage$39 = extractErrorMessage.h(OneTapErrors.None),
    _extractErrorMessage$40 = _slicedToArray(_extractErrorMessage$39, 2),
    oneTapError = _extractErrorMessage$40[0],
    setOneTapError = _extractErrorMessage$40[1];
  ...
  var _useLastUsedAuthMetho = useLastUsedAuthMethod(),
    _useLastUsedAuthMetho2 = _slicedToArray(_useLastUsedAuthMetho, 2),
    lastUsedMethod = _useLastUsedAuthMetho2[0],
    setLastUsedMethod = _useLastUsedAuthMetho2[1];
  var attemptToLoadOneTap = extractErrorMessage.T(function () {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee6() {
      var _g, _h, _j, _internal$readB2BInte2, oneTap, clientResult, client, oneTapCallback, renderResult;
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.n) {
          case 0:
            _internal$readB2BInte2 = internal.readB2BInternals(stytch), oneTap = _internal$readB2BInte2.oneTap;
            _context6.n = 1;
            return oneTap.createOneTapClient();
          case 1:
            clientResult = _context6.v;
  ...
  var fallbackButton = /*#__PURE__*/extractErrorMessage.wn.createElement(OAuthB2BButton, {
    ...
    providerParams: providerParams,
    onSuccess: function onSuccess() {
      return setLastUsedMethod(internal.B2BOAuthProviders.Google);
    }
  });
  var fallbackWithLastUsed = lastUsedMethod === internal.B2BOAuthProviders.Google ? (/*#__PURE__*/extractErrorMessage.wn.createElement("div", null, /*#__PURE__*/extractErrorMessage.wn.createElement(Text, {
    size: "helper",
    color: "secondary",
    align: "right"
  }, _t({
    id: 'provider.lastUsed',
    message: "Last used"
  })), fallbackButton)) : fallbackButton;
  var _internal$readB2BInte3 = internal.readB2BInternals(stytch),
    publicToken = _internal$readB2BInte3.publicToken;
  if (oneTapError !== OneTapErrors.None) {
    return /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null, internal.isTestPublicToken(publicToken) ? ErrorMessages[oneTapError] : null, fallbackWithLastUsed);
  }
...
var IdentityProviderIcon = function IdentityProviderIcon(_ref62) {
  var identityProvider = _ref62.identityProvider;
  var _a;
  var Icon = (_a = iconMap[identityProvider]) !== null && _a !== void 0 ? _a : SSOIcon;
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Icon, null);
};
var SSOButton = function SSOButton(props) {
  var _extractErrorMessage$41 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$41._;
  var stytchClient = useStytch();
  var config = useConfig();
  var onButtonClick = function onButtonClick() {
    var _a, _b;
    return stytchClient.sso.start({
      ...
      var _a;
      (_a = props.onStart) === null || _a === void 0 ? void 0 : _a.call(props, props.connection);
    });
  };
  var displayName = props.connection.display_name;
  var icon = /*#__PURE__*/extractErrorMessage.wn.createElement(IdentityProviderIcon, {
    identityProvider: props.connection.identity_provider
  });
  return /*#__PURE__*/extractErrorMessage.wn.createElement(AuthButton, {
...
function getSsoMethodKey(method) {
  return "sso:".concat(method.connection_id);
}
function extractConnectionId(method) {
  return (method === null || method === void 0 ? void 0 : method.startsWith('sso:')) ? method.slice(4) : undefined;
}
...
var SsoAndOAuthButtons = function SsoAndOAuthButtons(_ref63) {
  var buttons = _ref63.buttons;
  var _a;
  var _extractErrorMessage$42 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$42._;
  ...
  var _useEffectiveAuthConf3 = useEffectiveAuthConfig(),
    _useEffectiveAuthConf4 = _useEffectiveAuthConf3.oauthProviderSettings,
    oauthProviderSettings = _useEffectiveAuthConf4 === void 0 ? [] : _useEffectiveAuthConf4;
  var _useLastUsedAuthMetho3 = useLastUsedAuthMethod(),
    _useLastUsedAuthMetho4 = _slicedToArray(_useLastUsedAuthMetho3, 2),
    lastUsedMethod = _useLastUsedAuthMetho4[0],
    setLastUsedMethod = _useLastUsedAuthMetho4[1];
  var config = useConfig();
  ...
  var isDiscoveryFlow = state.flowState.type === internal.AuthFlowType.Discovery;
  var authButtons = buttons.flatMap(function (button) {
    var _a, _b, _c;
    if (button === Component.OAuthButtons) {
      return oauthProviderSettings.map(function (provider) {
        return {
          type: 'oauth',
          provider: provider
        };
      ...
      return isDiscoveryFlow ? {
        type: 'sso-discovery'
      } : (_c = (_b = (_a = state.flowState.organization) === null || _a === void 0 ? void 0 : _a.sso_active_connections) === null || _b === void 0 ? void 0 : _b.map(function (connection) {
        return {
          type: 'sso',
  ...
  var _internal$arrayUtils$ = internal.arrayUtils.moveToFront(authButtons, function (button) {
      return getButtonId(button) === lastUsedMethod;
    }),
    _internal$arrayUtils$2 = _slicedToArray(_internal$arrayUtils$, 2),
    reorderedButtons = _internal$arrayUtils$2[0],
    foundLastUsedOAuth = _internal$arrayUtils$2[1];
  var createOAuthButton = function createOAuthButton(oauthProvider) {
    var providerProps = {
    ...
    if (oauthProvider.one_tap) {
      return /*#__PURE__*/extractErrorMessage.wn.createElement(B2BGoogleOneTap, Object.assign({
        key: oauthProvider.type
      }, providerProps, {
        cancelOnTapOutside: oauthProvider.cancel_on_tap_outside
      }));
    }
    return /*#__PURE__*/extractErrorMessage.wn.createElement(OAuthB2BButton, Object.assign({
      key: oauthProvider.type,
      ...
      onSuccess: function onSuccess() {
        return setLastUsedMethod(oauthProvider.type);
      }
    }, providerProps));
  };
  return /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null, reorderedButtons.map(function (button, index) {
        ...
        case 'sso':
          return /*#__PURE__*/extractErrorMessage.wn.createElement(SSOButton, {
            ...
            onStart: function onStart() {
              return setLastUsedMethod(getSsoMethodKey(button.connection));
            }
          });
        case 'sso-discovery':
          return /*#__PURE__*/extractErrorMessage.wn.createElement(AuthButton, {
            key: "sso-discovery",
            icon: /*#__PURE__*/extractErrorMessage.wn.createElement(SSOIcon, null),
            onClick: function onClick() {
              dispatch({
                type: 'transition',
...
var Logo$2 = function Logo$2(_ref65) {
...
var ProductComponents = function ProductComponents(_ref66) {
  ...
  var renderedComponents = components.map(function (group) {
    return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
      ...
      direction: "column",
      gap: 8
    }, isButtonGroup(group) ? (/*#__PURE__*/extractErrorMessage.wn.createElement(SsoAndOAuthButtons, {
      buttons: group
...
var MainScreen = function MainScreen() {
  var _a, _b, _c;
  var _extractErrorMessage$43 = extractErrorMessage.Ze(),
    displayHeader = _extractErrorMessage$43.displayHeader,
    logo = _extractErrorMessage$43.logo;
  ...
  var _extractErrorMessage$44 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$44._;
...
var Link = extractErrorMessage.He.a(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  all: unset;\n\n  cursor: pointer;\n\n  &:hover,\n  &:focus-visible {\n    text-decoration: underline;\n    text-decoration-color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var EmailProviderLink = function EmailProviderLink(_ref67) {
  var _ref67$providerInfo = _ref67.providerInfo,
    icon = _ref67$providerInfo.icon,
    messageDescriptor = _ref67$providerInfo.messageDescriptor,
    getUrl = _ref67$providerInfo.getUrl,
    emailDomain = _ref67.emailDomain;
...
var useEmailDomain$1 = function useEmailDomain$1() {
  ...
  var stytch = useStytch();
  var config = useConfig();
  var _extractErrorMessage$47 = extractErrorMessage.h(function () {
    ...
    emailDomains = _extractErrorMessage$48[0],
    setEmailDomains = _extractErrorMessage$48[1];
  extractErrorMessage.p(function () {
...
var RightArrowSVG = function RightArrowSVG() {
  return /*#__PURE__*/extractErrorMessage.y$1(SvgNoShrink, {
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, /*#__PURE__*/extractErrorMessage.y$1("path", {
    d: "M7 0.333313L5.825 1.50831L10.475 6.16665H0.333334V7.83331H10.475L5.825 12.4916L7 13.6666L13.6667 6.99998L7 0.333313Z",
    fill: "currentColor"
  }));
};
var Logo$1 = function Logo$1(_ref77) {
  var name = _ref77.name,
    logo = _ref77.logo;
  if (logo !== '') {
    return /*#__PURE__*/extractErrorMessage.y$1(LogoImage, {
      src: logo
    });
  }
  return /*#__PURE__*/extractErrorMessage.y$1(LogoText, {
    alignItems: "center",
    justifyContent: "center"
  }, name[0]);
};
var ActionText = function ActionText(_ref78) {
  ...
  var _extractErrorMessage$49 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$49._;
  if (isJoinViaJitType(type) || type === 'pending_member') return /*#__PURE__*/extractErrorMessage.y$1(ArrowText, null, _t({
    id: 'organizationDiscovery.join',
    message: "Join"
  }));
  if (type === 'invited_member') return /*#__PURE__*/extractErrorMessage.y$1(ArrowText, null, _t({
    id: 'organizationDiscovery.acceptInvite',
    message: "Accept Invite"
  }));
  return /*#__PURE__*/extractErrorMessage.y$1(extractErrorMessage.g, null);
};
var DiscoverNoOrganizations = function DiscoverNoOrganizations() {
  ...
  if (shouldAutomaticallyCreateOrganization || isCreateLoading) {
    return /*#__PURE__*/extractErrorMessage.y$1(LoadingScreen, null);
  }
  ...
  if (createOrganizationEnabled && !config.disableCreateOrganization) {
    return /*#__PURE__*/extractErrorMessage.y$1(Flex, {
      direction: "column",
      gap: 24
    }, /*#__PURE__*/extractErrorMessage.y$1(BackArrow, {
      onClick: goBack
    }), /*#__PURE__*/extractErrorMessage.y$1(Text, {
      size: "header"
    }, _t2({
    ...
    })), /*#__PURE__*/extractErrorMessage.y$1(Button, {
      type: "button",
      onClick: function onClick() {
    ...
    })), /*#__PURE__*/extractErrorMessage.y$1(Text, null, _t2({
...
var Discovery = function Discovery() {
  ...
  if (isExchangeInProgress) {
    return /*#__PURE__*/extractErrorMessage.y$1(LoggingInScreen, null);
  }
  if (isCreateLoading) {
    return /*#__PURE__*/extractErrorMessage.y$1(LoadingScreen, null);
  }
  if (state.formState.discoveryState.discoveredOrganizations.length === 0) {
    return /*#__PURE__*/extractErrorMessage.y$1(DiscoverNoOrganizations, null);
  }
  ...
  return /*#__PURE__*/extractErrorMessage.y$1(Flex, {
  ...
  })), /*#__PURE__*/extractErrorMessage.y$1(Flex, {
    direction: "column",
    gap: 8
    ...
    return /*#__PURE__*/extractErrorMessage.y$1(OrganizationsRow, {
      padding: 8,
      ...
      gap: 8,
      alignItems: "center"
    }, /*#__PURE__*/extractErrorMessage.y$1(Logo$1, {
      name: organization.organization_name,
      logo: organization.organization_logo_url
    }), /*#__PURE__*/extractErrorMessage.y$1(OrganizationName, null, organization.organization_name)), /*#__PURE__*/extractErrorMessage.y$1(Flex, {
      gap: 8,
      alignItems: "center"
    }, /*#__PURE__*/extractErrorMessage.y$1(ActionText, {
      type: membership.type
    }), /*#__PURE__*/extractErrorMessage.y$1(RightArrowSVG, null)));
  })), showCreateOrganization && (/*#__PURE__*/extractErrorMessage.y$1(Flex, {
    direction: "column",
    gap: 8
  }, /*#__PURE__*/extractErrorMessage.y$1(Divider, null), /*#__PURE__*/extractErrorMessage.y$1(Button, {
    type: "button",
    variant: "outlined",
    onClick: function onClick() {
      return stytchCreateOrganization();
...
var ConfirmationSVG = function ConfirmationSVG() {
  return /*#__PURE__*/extractErrorMessage.y$1("svg", {
    width: "201",
    height: "200",
    viewBox: "0 0 201 200",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, /*#__PURE__*/extractErrorMessage.y$1("g", {
    opacity: "0.1"
  }, /*#__PURE__*/extractErrorMessage.y$1("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    ...
    fill: "#00AC26",
    fillOpacity: "0.12"
  }), /*#__PURE__*/extractErrorMessage.y$1("mask", {
    id: "mask0_1356_5135",
    style: {
      maskType: 'alpha'
    },
    ...
    fill: "white"
  }), /*#__PURE__*/extractErrorMessage.y$1("defs", null, /*#__PURE__*/extractErrorMessage.y$1("linearGradient", {
    ...
    y2: "338.297",
    gradientUnits: "userSpaceOnUse"
  }, /*#__PURE__*/extractErrorMessage.y$1("stop", {
    stopColor: "white"
  }), /*#__PURE__*/extractErrorMessage.y$1("stop", {
    offset: "1",
    stopColor: "#09F33D"
  })), /*#__PURE__*/extractErrorMessage.y$1("linearGradient", {
...
var Confirmation = function Confirmation(_ref80) {
  ...
  return /*#__PURE__*/extractErrorMessage.y$1(Flex, {
    ...
    size: "header"
  }, header !== null && header !== void 0 ? header : defaultHeader), /*#__PURE__*/extractErrorMessage.y$1(Text, null, text !== null && text !== void 0 ? text : defaultText), /*#__PURE__*/extractErrorMessage.y$1(ConfirmationSVG, null));
};
...
var ConfirmationScreen = function ConfirmationScreen() {
  ...
  return /*#__PURE__*/extractErrorMessage.y$1(Confirmation, null);
};
...
var StyledButton$1 = extractErrorMessage.He(BaseButton)(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  color: ", ";\n  padding: 20px 0;\n  border-bottom: 1px solid #e5e8eb;\n  font-weight: 500;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])), function (props) {
  return props.theme.colors.primary;
});
...
var EmailMethodSelectionScreen = function EmailMethodSelectionScreen() {
  var _useEffectiveAuthConf6 = useEffectiveAuthConfig(),
    products = _useEffectiveAuthConf6.products;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    var option = _ref82.option,
      messageDescriptor = _ref82.messageDescriptor;
...
var StyledButton = extractErrorMessage.He(BaseButton)(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n  font-weight: bold;\n\n  &:focus-visible,\n  &:hover {\n    outline: none;\n    text-decoration: underline;\n    text-decoration-color: ", ";\n  }\n\n  &:disabled {\n    pointer-events: none;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
...
var Wrapper = extractErrorMessage.He.div(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n  display: grid;\n  grid-template-rows: ", ";\n  transition: grid-template-rows 0.15s ease-out;\n"])), function (_ref84) {
  var isOpen = _ref84.isOpen;
  return isOpen ? '1fr' : '0fr';
});
var Inner = extractErrorMessage.He.div(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n  overflow: hidden;\n"])));
...
var Container = extractErrorMessage.He.div(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  height: 4px;\n  background-color: ", ";\n  border-radius: 3px;\n  overflow: hidden;\n"])), function (_ref86) {
  var theme = _ref86.theme;
  return theme.colors.disabled;
});
var loading = extractErrorMessage.Ue(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  0% {\n    transform: translateX(-100%);\n  }\n  100% {\n    transform: translateX(-1%);\n  }\n"])));
var Progress = extractErrorMessage.He.div(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  height: 100%;\n  width: 100%;\n  background-color: ", ";\n  animation: ", " 10s cubic-bezier(0.22, 1, 0.36, 1);\n"])), function (_ref87) {
...
var Digit = extractErrorMessage.He.div(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n  border: 1px solid ", ";\n  border-radius: 4px;\n  align-items: center;\n  display: flex;\n  font-size: 18px;\n  justify-content: center;\n  height: ", ";\n  width: ", ";\n  background: ", ";\n  color: ", ";\n"])), function (_ref89) {
...
var OTPControl = function OTPControl(_ref94) {
  ...
  var _extractErrorMessage$56 = extractErrorMessage.h(''),
    _extractErrorMessage$57 = _slicedToArray(_extractErrorMessage$56, 2),
    otp = _extractErrorMessage$57[0],
    setOtp = _extractErrorMessage$57[1];
...
var rollToSuccess = extractErrorMessage.Ue(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n  from {\n    transform: translateY(0%);\n  }\n  to {\n    transform: translateY(-50%);\n  }\n"])));
var rollToDefault = extractErrorMessage.Ue(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n  from {\n    transform: translateY(-50%);\n  }\n  to {\n    transform: translateY(0%);\n  }\n"])));
var AnimatedWrapper = extractErrorMessage.He.div(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["\n  position: relative;\n  overflow: hidden;\n  /* Set an explicit height to create the \"window\" the animation will be displayed in.  We match to the line height to ensure it looks inline with the text */\n  height: ", ";\n"])), function (_ref96) {
  var theme = _ref96.theme;
  return theme.typography.helper.lineHeight;
});
var RollingContainer = extractErrorMessage.He.div(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  animation: ", "\n    0.3s ease-out;\n  transform: ", ";\n"])), function (_ref97) {
  var displayCodeSent = _ref97.displayCodeSent,
    shouldAnimate = _ref97.shouldAnimate;
  if (!shouldAnimate) return 'none';
  return displayCodeSent ? rollToSuccess : rollToDefault;
}, function (_ref98) {
  var displayCodeSent = _ref98.displayCodeSent;
  return displayCodeSent ? 'translateY(-50%)' : 'translateY(0%)';
});
var StyledInlineButton = extractErrorMessage.He(InlineButton)(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n  color: ", ";\n"])), function (_ref99) {
  var theme = _ref99.theme,
    isCodeSending = _ref99.isCodeSending;
  return isCodeSending ? theme.colors.success : 'inherit';
});
var ExpirationMessage = function ExpirationMessage(_ref100) {
  var expiration = _ref100.expiration,
    resendOTP = _ref100.resendOTP,
    errorMessage = _ref100.errorMessage;
  var _extractErrorMessage$58 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$58._;
  var _extractErrorMessage$59 = extractErrorMessage.h(function () {
      return getSecondsRemaining(expiration);
    }),
    _extractErrorMessage$60 = _slicedToArray(_extractErrorMessage$59, 2),
    seconds = _extractErrorMessage$60[0],
    setSeconds = _extractErrorMessage$60[1];
  var _extractErrorMessage$61 = extractErrorMessage.h('initial'),
    _extractErrorMessage$62 = _slicedToArray(_extractErrorMessage$61, 2),
    resendState = _extractErrorMessage$62[0],
    setResendState = _extractErrorMessage$62[1];
  ...
  var handleResendClick = function handleResendClick() {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee7() {
      var _t5;
...
var SentOTPEntry = function SentOTPEntry(_ref101) {
  var expiration = _ref101.expiration,
    formattedDestination = _ref101.formattedDestination,
    isSubmitting = _ref101.isSubmitting,
    onSubmit = _ref101.onSubmit,
    errorMessage = _ref101.errorMessage,
    resendOTP = _ref101.resendOTP,
    resendErrorMessage = _ref101.resendErrorMessage;
  var _extractErrorMessage$63 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$63._;
...
var EmailOTPEntryScreen = function EmailOTPEntryScreen() {
  ...
  var _useMutate5 = useMutate('stytch.otps.email.discovery.authenticate', function (_, _ref102) {
      var _ref102$arg = _ref102.arg,
        otp = _ref102$arg.otp,
        email = _ref102$arg.email;
  ...
  var _useMutate6 = useMutate('stytch.otps.email.authenticate', function (_, _ref103) {
      var _ref103$arg = _ref103.arg,
        otp = _ref103$arg.otp,
        emailAddress = _ref103$arg.emailAddress,
        organizationId = _ref103$arg.organizationId,
        sessionDurationMinutes = _ref103$arg.sessionDurationMinutes;
  ...
  var handleResendOTP = function handleResendOTP() {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee8() {
...
var MFAEnrollmentSelectionScreen = function MFAEnrollmentSelectionScreen() {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    direction: "column"
  }, displayOptions.map(function (_ref104) {
    var option = _ref104.option,
      messageDescriptor = _ref104.messageDescriptor;
    return /*#__PURE__*/extractErrorMessage.wn.createElement(MenuButton, {
      key: option,
      onClick: function onClick() {
        handleChooseMethod(option);
...
var VerifyEmailConfirmation = function VerifyEmailConfirmation(_ref105) {
  var emailDomain = _ref105.emailDomain,
    reset = _ref105.reset,
    email = _ref105.email;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    components: {
      resendButton: /*#__PURE__*/extractErrorMessage.wn.createElement(HelpButton, {
        onClick: reset
      })
    }
  }))));
...
var useEmailDomain = function useEmailDomain() {
  ...
  var _extractErrorMessage$67 = extractErrorMessage.h(function () {
      var _internal$readB2BInte5 = internal.readB2BInternals(stytch).bootstrap.getSync(),
        emailDomains = _internal$readB2BInte5.emailDomains;
      return emailDomains;
    }),
    _extractErrorMessage$68 = _slicedToArray(_extractErrorMessage$67, 2),
    emailDomains = _extractErrorMessage$68[0],
    setEmailDomains = _extractErrorMessage$68[1];
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytch).bootstrap.getAsync().then(function (_ref106) {
      var emailDomains = _ref106.emailDomains;
      setEmailDomains(emailDomains);
    });
  }, [stytch]);
  if ((_a = config.emailMagicLinksOptions) === null || _a === void 0 ? void 0 : _a.domainHint) {
...
var Block = extractErrorMessage.He.div(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  height: 4px;\n  width: 25%;\n  background-color: ", ";\n"])), function (props) {
  return props.$bgColor;
});
var PasswordStrengthCheck = function PasswordStrengthCheck(_ref107) {
  var score = _ref107.score;
  var blocks = [];
  switch (score) {
    case 0:
    case 1:
...
var CheckIcon = function CheckIcon() {
  return /*#__PURE__*/extractErrorMessage.y$1(Flex, {
    height: 16,
    width: 16
  }, /*#__PURE__*/extractErrorMessage.y$1("svg", {
    width: "16",
    height: "16",
    viewBox: "0 0 16 16",
    fill: "none",
...
var BulletPoint = extractErrorMessage.He.div(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  width: 16px;\n  flex-shrink: 0;\n\n  &::before {\n    content: '\u2022';\n    font-size: ", ";\n    line-height: ", ";\n    color: ", ";\n  }\n"])), function (_ref108) {
...
var CrossIconContainer = extractErrorMessage.He.div(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n  flex-shrink: 0;\n  padding-top: 2px;\n"])));
var PasswordError = function PasswordError(_a) {
  var _b, _c, _d, _e, _f;
  var bootstrap = _a.bootstrap,
    props = internal.__rest(_a, ["bootstrap"]);
  var _extractErrorMessage$69 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$69._;
  ...
  var passwordBreachedMessage = props.isPasswordBreached && (/*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    gap: 4
...
var Form = extractErrorMessage.He.form(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
var PasswordResetForm = function PasswordResetForm() {
  ...
  var onEvent = useEventCallback();
  var onError = useErrorCallback();
  var _extractErrorMessage$71 = extractErrorMessage.F(function () {
    ...
    resetToken = _extractErrorMessage$72[0],
    resetTokenType = _extractErrorMessage$72[1];
  var dataLayer = internal.readB2BInternals(stytchClient).dataLayer;
  var email = dataLayer.getItem('reset-email-value');
  var _extractErrorMessage$73 = extractErrorMessage.h(''),
    _extractErrorMessage$74 = _slicedToArray(_extractErrorMessage$73, 2),
    password = _extractErrorMessage$74[0],
    setPassword = _extractErrorMessage$74[1];
  var _extractErrorMessage$75 = extractErrorMessage.h(''),
    _extractErrorMessage$76 = _slicedToArray(_extractErrorMessage$75, 2),
    errorMessage = _extractErrorMessage$76[0],
    setErrorMessage = _extractErrorMessage$76[1];
  var _extractErrorMessage$77 = extractErrorMessage.h(0),
    _extractErrorMessage$78 = _slicedToArray(_extractErrorMessage$77, 2),
    passwordScore = _extractErrorMessage$78[0],
    setPasswordScore = _extractErrorMessage$78[1];
  var _extractErrorMessage$79 = extractErrorMessage.h(''),
    _extractErrorMessage$80 = _slicedToArray(_extractErrorMessage$79, 2),
    passwordWarning = _extractErrorMessage$80[0],
    setPasswordWarning = _extractErrorMessage$80[1];
  var _extractErrorMessage$81 = extractErrorMessage.h([]),
    _extractErrorMessage$82 = _slicedToArray(_extractErrorMessage$81, 2),
    passwordSuggestions = _extractErrorMessage$82[0],
    setPasswordSuggestions = _extractErrorMessage$82[1];
  var _extractErrorMessage$83 = extractErrorMessage.h(true),
    _extractErrorMessage$84 = _slicedToArray(_extractErrorMessage$83, 2),
    invalidPassword = _extractErrorMessage$84[0],
    setInvalidPassword = _extractErrorMessage$84[1];
  var _extractErrorMessage$85 = extractErrorMessage.h(false),
    _extractErrorMessage$86 = _slicedToArray(_extractErrorMessage$85, 2),
    isSubmitting = _extractErrorMessage$86[0],
    setIsSubmitting = _extractErrorMessage$86[1];
  var _extractErrorMessage$87 = extractErrorMessage.h('none'),
    _extractErrorMessage$88 = _slicedToArray(_extractErrorMessage$87, 2),
    strengthPolicy = _extractErrorMessage$88[0],
    setStrengthPolicy = _extractErrorMessage$88[1];
  var _extractErrorMessage$89 = extractErrorMessage.h(0),
    _extractErrorMessage$90 = _slicedToArray(_extractErrorMessage$89, 2),
    missingCharacters = _extractErrorMessage$90[0],
    setMissingCharacters = _extractErrorMessage$90[1];
  var _extractErrorMessage$91 = extractErrorMessage.h(0),
    _extractErrorMessage$92 = _slicedToArray(_extractErrorMessage$91, 2),
    missingComplexity = _extractErrorMessage$92[0],
    setMissingComplexity = _extractErrorMessage$92[1];
  var _extractErrorMessage$93 = extractErrorMessage.h(false),
    _extractErrorMessage$94 = _slicedToArray(_extractErrorMessage$93, 2),
    isPasswordBreached = _extractErrorMessage$94[0],
    setIsPasswordBreached = _extractErrorMessage$94[1];
  var passwordProps = useErrorProps(errorMessage);
  var updateStrengthCheck = extractErrorMessage.F(function () {
    return internal.debounce(function (password) {
      return stytchClient.passwords.strengthCheck({
        ...
        var score = _ref111.score,
          valid_password = _ref111.valid_password,
          zxcvbn_feedback = _ref111.zxcvbn_feedback,
          luds_feedback = _ref111.luds_feedback,
          strength_policy = _ref111.strength_policy,
          breached_password = _ref111.breached_password;
  ...
  extractErrorMessage.p(function () {
    ...
    if (resetTokenType === 'multi_tenant_magic_links') {
      stytchClient.magicLinks.authenticate({
        ...
        b2b_index_headless.clearStytchTokenParams();
        dispatch({
          type: 'primary_authenticate_success',
          response: data,
          includedMfaMethods: config.mfaProductInclude,
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    type: "new"
  }, passwordProps.input)), /*#__PURE__*/extractErrorMessage.wn.createElement("div", Object.assign({}, passwordProps.error), /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordB2BError, {
...
var PasswordsAuthenticate = function PasswordsAuthenticate() {
  ...
  var _extractErrorMessage$95 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$95._;
  ...
  var passwordProps = useErrorProps(errorMessage);
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee9() {
  ...
  }), /*#__PURE__*/extractErrorMessage.wn.createElement(HelpButton, {
    onClick: onGetHelp
  }, _t({
    id: 'link.signupResetPassword',
    message: "Sign up or reset password"
...
var e = {
  ...
  t = function t(_t6) {
    if ("object" == (typeof window === "undefined" ? "undefined" : _typeof(window))) {
      var _e2 = (_t6 ? _t6.querySelector("#_goober") : window._goober) || Object.assign(document.createElement("style"), {
        innerHTML: " ",
        id: "_goober"
      });
      return _e2.nonce = window.__nonce__, _e2.parentNode || (_t6 || document.head).appendChild(_e2), _e2.firstChild;
    }
    return _t6 || e;
  },
  l = /(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,
  ...
  i = function i(e, t, r, _i, p) {
    ...
    if (!c[d]) {
      ...
      c[d] = _o2(p ? _defineProperty({}, "@keyframes " + d, _t8) : _t8, r ? "" : "." + d);
    }
  ...
  p = function p(e, t, r) {
    return e.reduce(function (e, l, a) {
      ...
      if (n && n.call) {
        var _e3 = n(r),
          _t9 = _e3 && _e3.props && _e3.props.className || /^go/.test(_e3) && _e3;
        n = _t9 ? "." + _t9 : _e3 && "object" == _typeof(_e3) ? _e3.props ? "" : _o2(_e3, "") : !1 === _e3 ? "" : _e3;
      }
      return e + l + (null == n ? "" : n);
    }, "");
  };
  ...
  b = function () {
    ...
    return function () {
      if (e === void 0 && (typeof window === "undefined" ? "undefined" : _typeof(window)) < "u") {
        var _t0 = matchMedia("(prefers-reduced-motion: reduce)");
        e = !_t0 || _t0.matches;
      }
      return e;
    };
...
var S = new Map(),
  ...
  I = function I() {
    ...
    var _extractErrorMessage$96 = extractErrorMessage.h(P),
      _extractErrorMessage$97 = _slicedToArray(_extractErrorMessage$96, 2),
      t = _extractErrorMessage$97[0],
      o = _extractErrorMessage$97[1];
    extractErrorMessage.p(function () {
  ...
  D = function D(e) {
    ...
    var s = extractErrorMessage.T(function () {
      ...
      a = extractErrorMessage.T(function (r, c) {
        var _g$filter;
        var _ref113 = c || {},
          _ref113$reverseOrder = _ref113.reverseOrder,
          i = _ref113$reverseOrder === void 0 ? !1 : _ref113$reverseOrder,
          _ref113$gutter = _ref113.gutter,
          d = _ref113$gutter === void 0 ? 8 : _ref113$gutter,
          p = _ref113.defaultPosition,
...
var oe = h$1(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\nfrom {\n  transform: scale(0) rotate(45deg);\n\topacity: 0;\n}\nto {\n transform: scale(1) rotate(45deg);\n  opacity: 1;\n}"]))),
  re = h$1(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\nfrom {\n  transform: scale(0);\n  opacity: 0;\n}\nto {\n  transform: scale(1);\n  opacity: 1;\n}"]))),
  se = h$1(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\nfrom {\n  transform: scale(0) rotate(90deg);\n\topacity: 0;\n}\nto {\n  transform: scale(1) rotate(90deg);\n\topacity: 1;\n}"]))),
  _ = w$1("div")(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  width: 20px;\n  opacity: 0;\n  height: 20px;\n  border-radius: 10px;\n  background: ", ";\n  position: relative;\n  transform: rotate(45deg);\n\n  animation: ", " 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)\n    forwards;\n  animation-delay: 100ms;\n\n  &:after,\n  &:before {\n    content: '';\n    animation: ", " 0.15s ease-out forwards;\n    animation-delay: 150ms;\n    position: absolute;\n    border-radius: 3px;\n    opacity: 0;\n    background: ", ";\n    bottom: 9px;\n    left: 4px;\n    height: 2px;\n    width: 12px;\n  }\n\n  &:before {\n    animation: ", " 0.15s ease-out forwards;\n    animation-delay: 180ms;\n    transform: rotate(90deg);\n  }\n"])), function (e) {
    return e.primary || "#ff4b4b";
  }, oe, re, function (e) {
    return e.secondary || "#fff";
  }, se);
var ne = h$1(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"]))),
  V = w$1("div")(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n  width: 12px;\n  height: 12px;\n  box-sizing: border-box;\n  border: 2px solid;\n  border-radius: 100%;\n  border-color: ", ";\n  border-right-color: ", ";\n  animation: ", " 1s linear infinite;\n"])), function (e) {
    return e.secondary || "#e0e0e0";
  }, function (e) {
    return e.primary || "#616161";
  }, ne);
var pe = h$1(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\nfrom {\n  transform: scale(0) rotate(45deg);\n\topacity: 0;\n}\nto {\n  transform: scale(1) rotate(45deg);\n\topacity: 1;\n}"]))),
  de = h$1(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n0% {\n\theight: 0;\n\twidth: 0;\n\topacity: 0;\n}\n40% {\n  height: 0;\n\twidth: 6px;\n\topacity: 1;\n}\n100% {\n  opacity: 1;\n  height: 10px;\n}"]))),
  w = w$1("div")(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  width: 20px;\n  opacity: 0;\n  height: 20px;\n  border-radius: 10px;\n  background: ", ";\n  position: relative;\n  transform: rotate(45deg);\n\n  animation: ", " 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)\n    forwards;\n  animation-delay: 100ms;\n  &:after {\n    content: '';\n    box-sizing: border-box;\n    animation: ", " 0.2s ease-out forwards;\n    opacity: 0;\n    animation-delay: 200ms;\n    position: absolute;\n    border-right: 2px solid;\n    border-bottom: 2px solid;\n    border-color: ", ";\n    bottom: 6px;\n    left: 6px;\n    height: 10px;\n    width: 6px;\n  }\n"])), function (e) {
    return e.primary || "#61d345";
  }, pe, de, function (e) {
    return e.secondary || "#fff";
  });
var ue = w$1("div")(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n  position: absolute;\n"]))),
  le = w$1("div")(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  position: relative;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  min-width: 20px;\n  min-height: 20px;\n"]))),
  Te = h$1(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral(["\nfrom {\n  transform: scale(0.6);\n  opacity: 0.4;\n}\nto {\n  transform: scale(1);\n  opacity: 1;\n}"]))),
  fe = w$1("div")(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n  position: relative;\n  transform: scale(0.6);\n  opacity: 0.4;\n  min-width: 20px;\n  animation: ", " 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)\n    forwards;\n"])), Te),
  M = function M(_ref114) {
    var e = _ref114.toast;
    var t = e.icon,
      o = e.type,
      s = e.iconTheme;
    return t !== void 0 ? typeof t == "string" ? extractErrorMessage.y$1(fe, null, t) : t : o === "blank" ? null : extractErrorMessage.y$1(le, null, extractErrorMessage.y$1(V, _objectSpread({}, s)), o !== "loading" && extractErrorMessage.y$1(ue, null, o === "error" ? extractErrorMessage.y$1(_, _objectSpread({}, s)) : extractErrorMessage.y$1(w, _objectSpread({}, s))));
  };
var ye = function ye(e) {
  ...
  be = w$1("div")(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  background: #fff;\n  color: #363636;\n  line-height: 1.3;\n  will-change: transform;\n  box-shadow: 0 3px 10px rgba(0, 0, 0, 0.1), 0 3px 3px rgba(0, 0, 0, 0.05);\n  max-width: 350px;\n  pointer-events: auto;\n  padding: 8px 10px;\n  border-radius: 8px;\n"]))),
  Se = w$1("div")(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  margin: 4px 10px;\n  color: inherit;\n  flex: 1 1 auto;\n  white-space: pre-line;\n"]))),
  Ae = function Ae(e, t) {
    var s = e.includes("top") ? 1 : -1,
      _ref115 = b() ? [he, xe] : [ye(s), ge(s)],
      _ref116 = _slicedToArray(_ref115, 2),
      a = _ref116[0],
      r = _ref116[1];
    return {
  ...
  F = extractErrorMessage.w(function (_ref117) {
    var e = _ref117.toast,
      t = _ref117.position,
      o = _ref117.style,
      s = _ref117.children;
    var a = e.height ? Ae(e.position || t || "top-center", e.visible) : {
      ...
      r = extractErrorMessage.y$1(M, {
        toast: e
      }),
      c = extractErrorMessage.y$1(Se, _objectSpread({}, e.ariaProps), T(e.message, e));
    return extractErrorMessage.y$1(be, {
      className: e.className,
      style: _objectSpread(_objectSpread(_objectSpread({}, a), o), e.style)
    }, typeof s == "function" ? s({
      icon: r,
      message: c
    }) : extractErrorMessage.y$1(extractErrorMessage.g, null, r, c));
  });
m(extractErrorMessage.y$1);
var Ee = function Ee(_ref118) {
    var e = _ref118.id,
      t = _ref118.className,
      o = _ref118.style,
      s = _ref118.onHeightUpdate,
      a = _ref118.children;
    ...
    return extractErrorMessage.y$1("div", {
      ref: r,
      className: t,
      style: o
    }, a);
  ...
  ve = u$1(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n  z-index: 9999;\n  > * {\n    pointer-events: auto;\n  }\n"]))),
  O = 16,
  Ie = function Ie(_ref119) {
    var e = _ref119.reverseOrder,
      _ref119$position = _ref119.position,
      t = _ref119$position === void 0 ? "top-center" : _ref119$position,
      o = _ref119.toastOptions,
      s = _ref119.gutter,
      a = _ref119.children,
      r = _ref119.containerStyle,
      c = _ref119.containerClassName;
    var _D = D(o),
      i = _D.toasts,
      d = _D.handlers;
    return extractErrorMessage.y$1("div", {
      ...
      var g = p.position || t,
        ...
        x = Re(g, E);
      return extractErrorMessage.y$1(Ee, {
        id: p.id,
        key: p.id,
        onHeightUpdate: d.updateHeight,
        className: p.visible ? ve : "",
        style: x
      }, p.type === "custom" ? T(p.message, p) : a ? a(p) : extractErrorMessage.y$1(F, {
        toast: p,
        position: g
      }));
    }));
...
var _t = n;
var ResendButton = function ResendButton(_ref120) {
  var onClick = _ref120.onClick,
...
var PasswordSetNew = function PasswordSetNew() {
  ...
  var onEvent = useEventCallback();
  var config = useConfig();
  var _extractErrorMessage$98 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$98._;
...
var PasswordsForgotForm = function PasswordsForgotForm() {
  ...
  var config = useConfig();
  var onEvent = useEventCallback();
  var _extractErrorMessage$99 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$99._;
  ...
  var emailProps = useErrorProps(errorMessage);
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee0() {
      var _a, _b, _c, _d, _e, _f;
      return _regenerator().w(function (_context0) {
        while (1) switch (_context0.n) {
          ...
          case 1:
            ...
            setIsSubmitting(true);
            if (organization) {
              internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref121) {
                var member = _ref121.member;
                var _a, _b, _c, _d, _e, _f;
                if (!member) {
                  handleNonMemberReset();
                  return;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement("form", {
    ...
    email: email,
    setEmail: setEmail
  }, emailProps.input)), /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, Object.assign({
    errorMessage: errorMessage
  }, emailProps.error)), /*#__PURE__*/extractErrorMessage.wn.createElement(SubmitButton, {
    isSubmitting: isSubmitting,
    text: _t({
...
var RecoveryCodeEntryScreen = function RecoveryCodeEntryScreen() {
  ...
  var _useMutate7 = useMutate('stytch.recoveryCodes.recover', function (_, _ref122) {
      var _ref122$arg = _ref122.arg,
        recoveryCode = _ref122$arg.recoveryCode,
  ...
  var _extractErrorMessage$101 = extractErrorMessage.h(''),
    _extractErrorMessage$102 = _slicedToArray(_extractErrorMessage$101, 2),
    recoveryCode = _extractErrorMessage$102[0],
    setRecoveryCode = _extractErrorMessage$102[1];
  var recoveryCodeProps = useErrorProps(error);
  var errorMessage = error ? _t({
    id: 'recoveryCodes.entry.error.invalidCode',
    message: "Invalid backup code, please try again."
  }) : undefined;
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee1() {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement("form", {
    ...
    required: true,
    autoComplete: "off"
  }, recoveryCodeProps.input)), errorMessage && /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, Object.assign({
    errorMessage: errorMessage
  }, recoveryCodeProps.error))), /*#__PURE__*/extractErrorMessage.wn.createElement(SubmitButton, {
    text: _t({
      id: 'button.continue',
      message: "Continue"
    }),
...
var InsetContainer = extractErrorMessage.He.div(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["\n  background-color: #f3f5f6;\n  color: #000;\n  font-size: 16px;\n  line-height: 28px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  gap: 8px;\n  padding: 16px 8px;\n"])));
var CodeList = extractErrorMessage.He.ul(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral(["\n  list-style: none;\n  padding: 0;\n  margin: 0;\n"])));
...
var RecoveryCodeSaveScreen = function RecoveryCodeSaveScreen() {
  ...
  var _extractErrorMessage$103 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$103._;
  ...
  var handleCodesCopy = function handleCodesCopy() {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee10() {
      var _t1;
...
var Select = extractErrorMessage.He.select(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: ", ";\n  height: 47px;\n  box-sizing: border-box;\n  padding: 0 8px;\n  color: ", ";\n  font-family: ", ";\n  width: 80px;\n  font-size: 18px;\n"])), function (props) {
  return props.theme.inputs.backgroundColor;
}, function (props) {
  return props.theme.inputs.borderColor;
}, function (props) {
...
var CountrySelector = function CountrySelector(_ref123) {
  var country = _ref123.country,
    setCountry = _ref123.setCountry;
  var _extractErrorMessage$104 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$104._;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Select, {
    ...
    name: "country-select",
    "aria-label": _t({
      id: 'formField.countryCode.label',
  ...
  }, Object.entries(internal.COUNTRIES_LIST).map(function (_ref124) {
    var _ref125 = _slicedToArray(_ref124, 2),
      countryCode = _ref125[0],
      countryNumber = _ref125[1];
...
var formatNumber = function formatNumber(_ref126) {
  var parsePhoneNumber = _ref126.parsePhoneNumber,
    phoneNumber = _ref126.phoneNumber,
    country = _ref126.country;
  return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee11() {
    var parsedPhoneNumber, _t10;
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        ...
        case 1:
          parsedPhoneNumber = _context11.v;
          if (parsedPhoneNumber) {
            _context11.n = 2;
            break;
          }
          return _context11.a(2, phoneNumber);
        case 2:
          return _context11.a(2, parsedPhoneNumber.national);
        case 3:
          _context11.p = 3;
          _t10 = _context11.v;
          return _context11.a(2, phoneNumber);
...
var formatNumberToIncludeCountryCode = function formatNumberToIncludeCountryCode(_ref127) {
  var parsePhoneNumber = _ref127.parsePhoneNumber,
    phoneNumber = _ref127.phoneNumber,
    country = _ref127.country;
  return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee12() {
    var code, fallbackNumber, fallback, parsedPhoneNumber, _t11;
    return _regenerator().w(function (_context12) {
      while (1) switch (_context12.p = _context12.n) {
        ...
        case 2:
          parsedPhoneNumber = _context12.v;
          if (parsedPhoneNumber) {
            _context12.n = 3;
            break;
          }
          return _context12.a(2, fallback);
        case 3:
          return _context12.a(2, parsedPhoneNumber);
        case 4:
          _context12.p = 4;
          _t11 = _context12.v;
          return _context12.a(2, fallback);
...
var PhoneStyledInput = extractErrorMessage.He(Input)(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["\n  flex-grow: 1;\n  min-width: 100px;\n"])));
var PhoneInput = function PhoneInput(_a) {
  var phone = _a.phone,
    setPhone = _a.setPhone,
    country = _a.country,
    setCountry = _a.setCountry,
    parsePhoneNumber = _a.parsePhoneNumber,
    hasPasskeys = _a.hasPasskeys,
    additionalProps = internal.__rest(_a, ["phone", "setPhone", "country", "setCountry", "parsePhoneNumber", "hasPasskeys"]);
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    direction: "row",
    wrap: "nowrap",
    ...
    type: "text",
    onChange: function onChange(e) {
      return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee13() {
...
var SMSOTPEnrollScreen = function SMSOTPEnrollScreen() {
  ...
  var _extractErrorMessage$106 = extractErrorMessage.wn.useState((_a = enrolledNumber === null || enrolledNumber === void 0 ? void 0 : enrolledNumber.countryCode) !== null && _a !== void 0 ? _a : DEFAULT_COUNTRY_CODE),
    _extractErrorMessage$107 = _slicedToArray(_extractErrorMessage$106, 2),
    countryCode = _extractErrorMessage$107[0],
    setCountryCode = _extractErrorMessage$107[1];
  var _extractErrorMessage$108 = extractErrorMessage.wn.useState((_b = enrolledNumber === null || enrolledNumber === void 0 ? void 0 : enrolledNumber.phoneNumber) !== null && _b !== void 0 ? _b : ''),
    _extractErrorMessage$109 = _slicedToArray(_extractErrorMessage$108, 2),
    phoneNumber = _extractErrorMessage$109[0],
    setPhoneNumber = _extractErrorMessage$109[1];
  ...
  var phoneInputLabel = _t({
    id: 'formField.phone.label',
  ...
  var _useMutate8 = useMutate('stytch.otps.sms.send', function (_, _ref128) {
      ...
      return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee14() {
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.n) {
            case 0:
              return _context14.a(2, stytchClient.otps.sms.send({
  ...
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee15() {
      var parsedNumber, _t12;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement("form", {
    ...
    direction: "column",
    gap: 24
  }, canGoBack(state) && /*#__PURE__*/extractErrorMessage.wn.createElement(BackArrow, {
    onClick: function onClick() {
      return dispatch({
        type: 'navigate_back'
      });
    ...
    direction: "column"
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(PhoneInput, Object.assign({
    country: countryCode,
  ...
  }, phoneProps.input)), errorMessage && /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, Object.assign({
    errorMessage: errorMessage
  }, phoneProps.error))), /*#__PURE__*/extractErrorMessage.wn.createElement(SubmitButton, {
    text: _t({
      id: 'button.continue',
      message: "Continue"
    }),
...
var SMSOTPEntryScreen = function SMSOTPEntryScreen() {
  ...
  var _extractErrorMessage$110 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$110._;
  ...
  var _state$mfa = state.mfa,
    ...
    smsOtp = _state$mfa.smsOtp,
    primaryInfo = _state$mfa.primaryInfo;
  var codeExpiration = smsOtp.codeExpiration,
    formattedDestination = smsOtp.formattedDestination;
  var enrolledMfaMethods = primaryInfo.enrolledMfaMethods,
    memberId = primaryInfo.memberId,
    memberPhoneNumber = primaryInfo.memberPhoneNumber,
    organizationId = primaryInfo.organizationId,
    organizationMfaOptionsSupported = primaryInfo.organizationMfaOptionsSupported;
  ...
  var handleResendOTP = function handleResendOTP() {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee17() {
...
var useSsoDiscoveryConnection = function useSsoDiscoveryConnection() {
  ...
  return useMutate('stytch.sso.discoverConnections', function (_key, _ref131) {
    ...
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee18() {
...
var SSODiscoveryEmail = function SSODiscoveryEmail() {
  ...
  var _extractErrorMessage$111 = extractErrorMessage.h(''),
    _extractErrorMessage$112 = _slicedToArray(_extractErrorMessage$111, 2),
    email = _extractErrorMessage$112[0],
    setEmail = _extractErrorMessage$112[1];
  var _extractErrorMessage$113 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$113._;
  var _extractErrorMessage$114 = extractErrorMessage.h(null),
    _extractErrorMessage$115 = _slicedToArray(_extractErrorMessage$114, 2),
    error = _extractErrorMessage$115[0],
    setError = _extractErrorMessage$115[1];
  var _extractErrorMessage$116 = extractErrorMessage.h(false),
    _extractErrorMessage$117 = _slicedToArray(_extractErrorMessage$116, 2),
    isLoading = _extractErrorMessage$117[0],
    setIsLoading = _extractErrorMessage$117[1];
  var _useSsoDiscoveryConne = useSsoDiscoveryConnection(),
    trigger = _useSsoDiscoveryConne.trigger;
  var emailProps = useErrorProps(error);
  var emailInputLabel = _t({
    id: 'formField.email.label',
    message: "Email"
  });
  var stytch = useStytch();
  ...
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee20() {
      var tryGetConnections, connections, _connections, connection, _t14;
        ...
        while (1) switch (_context20.p = _context20.n) {
          case 0:
            ...
            tryGetConnections = function tryGetConnections() {
              return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee19() {
                var _a, response, _t13;
                return _regenerator().w(function (_context19) {
                  while (1) switch (_context19.p = _context19.n) {
                    ...
                    case 2:
                      return _context19.a(2, response.connections);
                    case 3:
                      _context19.p = 3;
                      _t13 = _context19.v;
                      setError((_a = extractErrorMessage.extractErrorMessage(_t13, _t({
...
var SSOButtons = function SSOButtons(_ref132) {
  var availableConnections = _ref132.availableConnections;
  var _extractErrorMessage$118 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$118._;
  var _useLastUsedAuthMetho5 = useLastUsedAuthMethod(),
    _useLastUsedAuthMetho6 = _slicedToArray(_useLastUsedAuthMetho5, 2),
    lastUsedMethod = _useLastUsedAuthMetho6[0],
    setLastUsedMethod = _useLastUsedAuthMetho6[1];
  var lastUsedSso = extractConnectionId(lastUsedMethod);
  var _internal$arrayUtils$3 = internal.arrayUtils.moveToFront(availableConnections, function (connection) {
      return connection.connection_id === lastUsedSso;
    }),
    _internal$arrayUtils$4 = _slicedToArray(_internal$arrayUtils$3, 2),
    connections = _internal$arrayUtils$4[0],
    foundLastUsed = _internal$arrayUtils$4[1];
  return /*#__PURE__*/extractErrorMessage.y$1(Flex, {
    direction: "column",
    gap: 8,
    className: "oauth-buttons"
  }, connections.map(function (provider, index) {
    var button = /*#__PURE__*/extractErrorMessage.y$1(SSOButton, {
      key: provider.display_name,
      connection: provider,
      onStart: function onStart(connection) {
        return setLastUsedMethod(getSsoMethodKey(connection));
      }
    });
    if (foundLastUsed && index === 0) {
      return /*#__PURE__*/extractErrorMessage.y$1("div", {
        key: provider.display_name
      }, /*#__PURE__*/extractErrorMessage.y$1(Text, {
        size: "helper",
        color: "secondary",
...
var SSODiscoveryMenu = function SSODiscoveryMenu() {
  ...
  var _extractErrorMessage$119 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$119._;
  var handleBack = function handleBack() {
    dispatch({
      type: 'navigate_back'
    });
  ...
  })), /*#__PURE__*/extractErrorMessage.y$1(SSOButtons, {
    availableConnections: state.formState.ssoDiscoveryState.connections
  }));
};
var SSODiscoveryFallback = function SSODiscoveryFallback() {
  ...
  var _useMutate1 = useMutate('stytch.organization.getBySlug', function (_, _ref133) {
      var slug = _ref133.arg.slug;
      return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee21() {
        return _regenerator().w(function (_context21) {
          while (1) switch (_context21.n) {
            case 0:
              return _context21.a(2, stytchClient.organization.getBySlug({
                organization_slug: slug
              }));
          }
        }, _callee21);
  ...
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee22() {
  ...
  var slugProps = useErrorProps(error);
  ...
  }, slugProps.input)), error && /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, Object.assign({
    errorMessage: error
  }, slugProps.error))), /*#__PURE__*/extractErrorMessage.wn.createElement(SubmitButton, {
    text: _t({
      id: 'button.continue',
      message: "Continue"
    }),
...
var CopyButton = extractErrorMessage.He(BaseButton)(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["\n  flex: 0 0 24px;\n  height: 28px;\n  opacity: 0;\n\n  :focus {\n    opacity: 1;\n  }\n"])));
var CodeContainer = extractErrorMessage.He(InsetContainer)(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  :hover ", " {\n    opacity: 1;\n  }\n"])), CopyButton);
var Spacer = extractErrorMessage.He.div(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["\n  flex: 0 1 24px;\n"])));
var Code = extractErrorMessage.He.code(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["\n  white-space: pre-wrap;\n  align-self: center;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-wrap: wrap;\n  gap: 1ch;\n"])));
var TOTPEnrollManualScreen = function TOTPEnrollManualScreen() {
  ...
  var handleCodeCopy = function handleCodeCopy(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee23() {
      var _t15;
...
var QRCodeImg = extractErrorMessage.He.img(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral(["\n  margin: 0 auto;\n"])));
var TOTPEnrollQRScreen = function TOTPEnrollQRScreen() {
  ...
  var _useMutate10 = useMutate('stytch.totp.create', function (_, _ref134) {
      var _ref134$arg = _ref134.arg,
        memberId = _ref134$arg.memberId,
        organizationId = _ref134$arg.organizationId;
      dispatch({
        type: 'totp/create'
      });
...
var TOTPEntry = function TOTPEntry(_ref135) {
  var helperContent = _ref135.helperContent,
    isSubmitting = _ref135.isSubmitting,
    onSubmit = _ref135.onSubmit,
    errorMessage = _ref135.errorMessage;
...
var TOTPEntryScreen = function TOTPEntryScreen() {
  ...
  var _state$mfa$primaryInf4 = state.mfa.primaryInfo,
    enrolledMfaMethods = _state$mfa$primaryInf4.enrolledMfaMethods,
    memberId = _state$mfa$primaryInf4.memberId,
    organizationId = _state$mfa$primaryInf4.organizationId,
    organizationMfaOptionsSupported = _state$mfa$primaryInf4.organizationMfaOptionsSupported;
  var _useMutate11 = useMutate('stytch.totp.authenticate', function (_, _ref136) {
      var _ref136$arg = _ref136.arg,
        memberId = _ref136$arg.memberId,
        organizationId = _ref136$arg.organizationId,
        otp = _ref136$arg.otp,
        sessionDurationMinutes = _ref136$arg.sessionDurationMinutes;
  ...
  var handleSubmit = function handleSubmit(otp) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee24() {
...
var OuterContainer = extractErrorMessage.He.div(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["\n  width: ", ";\n  font-family: ", ";\n  box-sizing: border-box;\n  * {\n    box-sizing: content-box;\n  }\n  background-color: ", ";\n  border: ", ";\n  border-radius: ", ";\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n  border-bottom: ", ";\n"])), function (_ref137) {
  ...
  var theme = _ref144.theme,
    displayWatermark = _ref144.displayWatermark;
  return displayWatermark ? 'none' : theme.container.border;
});
var ChildrenContainer = extractErrorMessage.He.div(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["\n  padding: 24px 32px;\n"])));
var WatermarkContainer = extractErrorMessage.He.div(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  width: ", ";\n  background-color: ", ";\n  border: ", ";\n  border-top: none;\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n  overflow: hidden;\n"])), function (_ref145) {
...
var InnerContainer = extractErrorMessage.He.div(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral(["\n  background-color: #fff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  opacity: 0.5;\n"])));
var Image = extractErrorMessage.He.img(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral(["\n  width: 150px;\n"])));
var POWERED_BY_STYTCH_IMG_URL = 'https://public-assets.stytch.com/powered_by_stytch_logo_dark.svg';
var LoadingContainer = function LoadingContainer(_ref150) {
...
var MainContainer = function MainContainer(_ref151) {
  var children = _ref151.children,
    displayWatermark = _ref151.displayWatermark;
...
var createProfileScopeDescription = function createProfileScopeDescription(_ref152) {
  var containsProfile = _ref152.containsProfile,
    containsEmail = _ref152.containsEmail,
    containsPhoneNumber = _ref152.containsPhoneNumber;
  var details = [];
  if (containsProfile) {
...
var fallbackConsentManifestGenerator = function fallbackConsentManifestGenerator(_ref153) {
  var scopes = _ref153.scopes,
    clientName = _ref153.clientName,
    rbacPolicy = _ref153.rbacPolicy;
  return [{
...
var parseOAuthAuthorizeParams = function parseOAuthAuthorizeParams(params) {
  ...
  for (var _i4 = 0, _optionalStringFields = optionalStringFields; _i4 < _optionalStringFields.length; _i4++) {
    var _field = _optionalStringFields[_i4];
...
var ScopeList = extractErrorMessage.He.ul(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral(["\n  padding: 0;\n"])));
var ScopeListItem = extractErrorMessage.He.li(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral(["\n  padding: 4px;\n  box-sizing: border-box;\n  position: relative;\n  list-style: none;\n\n  &:not(:last-child) {\n    border-bottom: 1px solid ", ";\n  }\n"])), function (_ref154) {
  var theme = _ref154.theme;
  return theme.colors.secondary;
});
var ItemSummary = extractErrorMessage.He.summary(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral(["\n  list-style: none;\n  display: flex;\n  justify-content: space-between;\n  cursor: ", ";\n"])), function (props) {
  return props.expandable ? 'pointer' : 'default';
});
var DropdownArrowSvg = extractErrorMessage.He.svg(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral(["\n  width: 32px;\n  height: 32px;\n  margin-left: 10px;\n  margin-top: -5px;\n  vertical-align: top;\n  flex-shrink: 0;\n  transition: transform 0.3s ease;\n  details[open] & {\n    transform: rotate(90deg);\n  }\n"])));
var ItemNestedDetailsList = extractErrorMessage.He.ul(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral(["\n  padding: 4px 24px;\n  list-style: none;\n"])));
...
var SectionHeader = extractErrorMessage.He(Text)(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral(["\n  font-weight: 600;\n"])));
...
var UngrantableSection = extractErrorMessage.He.details(_templateObject87 || (_templateObject87 = _taggedTemplateLiteral(["\n  border: ", ";\n  border-radius: ", ";\n  padding: 16px;\n  margin-bottom: 36px;\n"])), function (_ref158) {
...
var UngrantableSummary = extractErrorMessage.He.summary(_templateObject88 || (_templateObject88 = _taggedTemplateLiteral(["\n  list-style: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  cursor: pointer;\n\n  details[open] > & {\n    padding-bottom: 8px;\n    margin-bottom: 8px;\n    border-bottom: 1px solid ", ";\n  }\n"])), function (_ref160) {
  var theme = _ref160.theme;
  return theme.colors.secondary;
});
var UngrantableNestedDetailsList = extractErrorMessage.He.ul(_templateObject89 || (_templateObject89 = _taggedTemplateLiteral(["\n  padding: 4px;\n  margin: 0;\n  list-style: none;\n"])));
...
var IDPContextProvider = function IDPContextProvider(_ref162) {
  var children = _ref162.children,
    consentManifestGenerator = _ref162.consentManifestGenerator,
    authTokenParams = _ref162.authTokenParams;
...
var Logo = extractErrorMessage.He.img(_templateObject90 || (_templateObject90 = _taggedTemplateLiteral(["\n  max-height: 50px;\n  max-width: 100px;\n"])));
...
var useIDPState = function useIDPState(_ref163) {
  var initialError = _ref163.initialError,
    initialParams = _ref163.initialParams,
    oauthAuthorizeStart = _ref163.oauthAuthorizeStart,
    oauthAuthorizeSubmit = _ref163.oauthAuthorizeSubmit,
    onError = _ref163.onError,
    onEvent = _ref163.onEvent;
  ...
  extractErrorMessage.p(function () {
    ...
    onError(new internal.IDPOAuthFlowMissingParamError(initialError));
  }, [initialError, onError]);
  var submitInternal = extractErrorMessage.T(function (_ref164) {
    var consent_required = _ref164.consent_required,
      consent_granted = _ref164.consent_granted;
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee25() {
      var submitResp;
  ...
  var submit = extractErrorMessage.T(function (_ref165) {
    var consent_granted = _ref165.consent_granted;
  ...
  var loadClient = extractErrorMessage.T(function () {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee26() {
      var startResponse, err, message, grantable, ungrantable, _t16;
      return _regenerator().w(function (_context26) {
        while (1) switch (_context26.p = _context26.n) {
          ...
          case 2:
            startResponse = _context26.v;
            _context26.n = 4;
            break;
          case 3:
            _context26.p = 3;
            _t16 = _context26.v;
            err = internal.StytchAPIError.from(_t16);
...
var IDPConsent = function IDPConsent(_ref166) {
  var bootstrap = _ref166.bootstrap,
    bootstrapNotLoaded = _ref166.bootstrapNotLoaded,
    state = _ref166.state,
...
var Consent = function Consent(_ref167) {
  var client = _ref167.client,
    submit = _ref167.submit,
    grantableScope = _ref167.grantableScope,
    projectName = _ref167.projectName,
    children = _ref167.children;
...
var useLogoutState = function useLogoutState(_ref168) {
  var initialError = _ref168.initialError,
    initialParams = _ref168.initialParams,
    oauthLogoutStart = _ref168.oauthLogoutStart,
    revokeSession = _ref168.revokeSession,
  ...
  var submitInternal = extractErrorMessage.T(function (redirectURI) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee27() {
      var _t17;
  ...
  var logoutPreflight = extractErrorMessage.T(function () {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee28() {
      var startResponse, err, message, _t18;
      return _regenerator().w(function (_context28) {
        while (1) switch (_context28.p = _context28.n) {
          ...
          case 2:
            startResponse = _context28.v;
            _context28.n = 4;
            break;
          case 3:
            _context28.p = 3;
            _t18 = _context28.v;
            err = internal.StytchAPIError.from(_t18);
            message = err.error_message;
            dispatch({
              type: 'PREFLIGHT_ERROR',
              error: message
  ...
  var submit = extractErrorMessage.T(function (_ref169) {
    var consent_granted = _ref169.consent_granted;
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee29() {
      return _regenerator().w(function (_context29) {
        while (1) switch (_context29.n) {
          case 0:
            ...
            return _context29.a(2, submitInternal(state.redirect_uri));
          case 1:
            dispatch({
              type: 'CONSENT_DENIED'
            });
...
var IDPLogout = function IDPLogout(_ref170) {
  var state = _ref170.state,
    submit = _ref170.submit,
    bootstrap = _ref170.bootstrap,
    bootstrapNotLoaded = _ref170.bootstrapNotLoaded;
...
var IDPConsentScreenImpl = function IDPConsentScreenImpl(_ref171) {
  var initialError = _ref171.initialError,
    initialParams = _ref171.initialParams;
  var stytchClient = useStytch();
  var onError = useErrorCallback();
  var onEvent = useEventCallback();
  var _stytchClient$idp = stytchClient.idp,
    oauthAuthorizeStart = _stytchClient$idp.oauthAuthorizeStart,
    oauthAuthorizeSubmit = _stytchClient$idp.oauthAuthorizeSubmit;
  var bootstrap = useBootstrap();
...
var IDPLogoutScreenImpl = function IDPLogoutScreenImpl(_ref172) {
  var initialError = _ref172.initialError,
    initialParams = _ref172.initialParams;
  var stytchClient = useStytch();
  var onError = useErrorCallback();
...
var IDPConsentScreen = function IDPConsentScreen() {
  var _ref173 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    _ref173$searchParams = _ref173.searchParams,
    searchParams = _ref173$searchParams === void 0 ? window.location.search : _ref173$searchParams;
  var _extractErrorMessage$142 = extractErrorMessage.h(parseIDPParams(searchParams)),
    _extractErrorMessage$143 = _slicedToArray(_extractErrorMessage$142, 1),
    _extractErrorMessage$144 = _extractErrorMessage$143[0],
    flow = _extractErrorMessage$144.flow,
    error = _extractErrorMessage$144.error;
  switch (flow.type) {
    case 'Authorize':
      return /*#__PURE__*/extractErrorMessage.wn.createElement(EnsureMemberIsLoggedIn, null, /*#__PURE__*/extractErrorMessage.wn.createElement(IDPConsentScreenImpl, {
        initialError: error,
        initialParams: flow.params
      }));
    case 'Logout':
      return /*#__PURE__*/extractErrorMessage.wn.createElement(IDPLogoutScreenImpl, {
        initialError: error,
        initialParams: flow.params
      });
  }
};
var EnsureMemberIsLoggedIn = function EnsureMemberIsLoggedIn(_ref174) {
  var children = _ref174.children;
  var _extractErrorMessage$145 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$145._;
  ...
  var _extractErrorMessage$146 = extractErrorMessage.h(false),
    _extractErrorMessage$147 = _slicedToArray(_extractErrorMessage$146, 2),
    attesting = _extractErrorMessage$147[0],
    setAttesting = _extractErrorMessage$147[1];
  var _extractErrorMessage$148 = extractErrorMessage.h(false),
    _extractErrorMessage$149 = _slicedToArray(_extractErrorMessage$148, 2),
    attested = _extractErrorMessage$149[0],
    setAttested = _extractErrorMessage$149[1];
  extractErrorMessage.p(function () {
    if (attesting || attested) return;
    var attestTrustedToken = function attestTrustedToken(authParams) {
      return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee30() {
        var token, profile_id, _member, _t19;
        return _regenerator().w(function (_context30) {
          while (1) switch (_context30.p = _context30.n) {
            case 0:
              if (!((authParams === null || authParams === void 0 ? void 0 : authParams.trustedAuthToken) && (authParams === null || authParams === void 0 ? void 0 : authParams.tokenProfileID))) {
                _context30.n = 5;
                break;
              }
              setAttesting(true);
              token = authParams.trustedAuthToken;
              profile_id = authParams.tokenProfileID;
              _member = stytchClient.self.getSync();
              if (!_member) {
                _context30.n = 1;
                break;
              }
            ...
            case 1:
              ...
              return stytchClient.session.attest({
                ...
                organization_id: _member === null || _member === void 0 ? void 0 : _member.organization_id,
            ...
            case 3:
              _context30.p = 3;
              _t19 = _context30.v;
              onErrorRef.current(_t19);
            case 4:
              _context30.p = 4;
              setAttesting(false);
              setAttested(true);
              return _context30.f(4);
            case 5:
              setAttested(true);
            case 6:
              return _context30.a(2);
          }
        }, _callee30, null, [[1, 3, 4, 5]]);
      }));
    };
...
var AppContainer$1 = function AppContainer$1() {
  ...
  var triggerEvent = useEventCallback();
  var config = useConfig();
  var _extractErrorMessage$150 = extractErrorMessage.Ze(),
    displayWatermark = _extractErrorMessage$150.displayWatermark;
  var isOnlyFloatingOneTap = useIsOnlyFloatingOneTap();
  ...
  var handleStytchAPIError = function handleStytchAPIError(error) {
    var defaultErrorType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ErrorType.Default;
    var _a;
    var error_type = extractErrorType(error);
    var errorType = (_a = errorTypeMap[error_type]) !== null && _a !== void 0 ? _a : defaultErrorType;
    dispatch({
      type: 'set_error_message_and_transition',
      errorType: errorType,
      canGoBack: false
  ...
  var _extractErrorMessage$151 = extractErrorMessage.h(false),
    _extractErrorMessage$152 = _slicedToArray(_extractErrorMessage$151, 2),
    isTokenAuthLoading = _extractErrorMessage$152[0],
    setIsTokenAuthLoading = _extractErrorMessage$152[1];
  var _extractErrorMessage$153 = extractErrorMessage.useSWRConfig(),
    mutate = _extractErrorMessage$153.mutate;
  ...
  extractErrorMessage.p(function () {
    ...
    var parsed = stytchClient.parseAuthenticateUrl();
    if (!(parsed === null || parsed === void 0 ? void 0 : parsed.handled)) {
      return;
    }
    var _authTokenConfig$pars = authTokenConfig[parsed.tokenType],
      mutationKey = _authTokenConfig$pars.mutationKey,
      defaultError = _authTokenConfig$pars.defaultError,
      onSuccess = _authTokenConfig$pars.onSuccess;
    setIsTokenAuthLoading(true);
    mutate(mutationKey, stytchClient.authenticateByUrl({
      session_duration_minutes: config.sessionOptions.sessionDurationMinutes
    })).then(function (result) {
      if (!(result === null || result === void 0 ? void 0 : result.handled)) return;
      var data = result.data;
      var event = getStytchEventByKey(mutationKey);
      if (event) {
        triggerEvent({
          type: event,
          data: data
      ...
      return setIsTokenAuthLoading(false);
    });
  }, []);
  extractErrorMessage.p(function () {
    if (isOnlyFloatingOneTap) {
  ...
  }, [dispatch, isOnlyFloatingOneTap, isTokenAuthLoading, resultPending, slug, state.flowState.organization, state.flowState.type, state.screen, stytchClient, triggerError]);
  if (isOnlyFloatingOneTap) {
...
var AppContainer = function AppContainer(_ref175) {
  var client = _ref175.client,
    styles = _ref175.styles,
    callbacks = _ref175.callbacks,
    config = _ref175.config,
    strings = _ref175.strings;
  var _extractErrorMessage$154 = extractErrorMessage.h(function () {
    ...
    _extractErrorMessage$155 = _slicedToArray(_extractErrorMessage$154, 2),
    displayWatermark = _extractErrorMessage$155[0],
    setDisplayWatermark = _extractErrorMessage$155[1];
  extractErrorMessage.p(function () {
...
var B2BIDPContainer = function B2BIDPContainer(_ref176) {
  var client = _ref176.client,
    ...
    strings = _ref176.strings,
    getIDPConsentManifest = _ref176.getIDPConsentManifest,
    trustedAuthTokenParams = _ref176.trustedAuthTokenParams;
  var initialState = Object.assign(Object.assign({}, DEFAULT_STATE), {
  ...
  return _createClass(StytchB2BUIClient, [{
    ...
    value: function mountIdentityProvider(_ref178) {
      var elementId = _ref178.elementId,
        ...
        strings = _ref178.strings,
        getIDPConsentManifest = _ref178.getIDPConsentManifest,
        trustedAuthTokenParams = _ref178.trustedAuthTokenParams;
      var _a;
      var targetParentDomNode = document.querySelector(elementId);
      if (!targetParentDomNode) {

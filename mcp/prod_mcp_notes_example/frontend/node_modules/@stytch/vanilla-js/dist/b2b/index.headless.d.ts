...
import { O as OneTapRenderResult, P as ParseAuthenticateUrl, A as AuthenticateByUrl } from '../createAuthUrlHandler-kCp0W81C.js';
...
type HandledTokenType = 'discovery' | 'discovery_oauth' | 'oauth' | 'sso' | 'multi_tenant_magic_links' | 'multi_tenant_impersonation';
/**
